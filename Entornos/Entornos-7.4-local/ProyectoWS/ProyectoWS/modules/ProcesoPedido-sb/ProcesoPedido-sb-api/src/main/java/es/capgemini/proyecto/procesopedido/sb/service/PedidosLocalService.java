...
/**
 * Provides the local service interface for Pedidos. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PedidosLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PedidosLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>es.capgemini.proyecto.procesopedido.sb.service.impl.PedidosLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pedidos local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PedidosLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Pedidos createPedidos(long id);
	...
	public Pedidos deletePedidos(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Pedidos deletePedidos(Pedidos pedidos);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pedidos fetchPedidos(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pedidos getPedidos(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Pedidos> getPedidoses(int start, int end);
