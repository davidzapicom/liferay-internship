...
/**
 * Provides the local service utility for Pedidos. This utility wraps
 * <code>es.capgemini.proyecto.procesopedido.sb.service.impl.PedidosLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PedidosLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>es.capgemini.proyecto.procesopedido.sb.service.impl.PedidosLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Pedidos addPedidos(Pedidos pedidos) {
		return getService().addPedidos(pedidos);
	}
	 ...
	 */
	public static Pedidos createPedidos(long id) {
		return getService().createPedidos(id);
	}
	 ...
	 */
	public static Pedidos deletePedidos(long id) throws PortalException {
		return getService().deletePedidos(id);
	}
	 ...
	 * @return the pedidos that was removed
	 */
	public static Pedidos deletePedidos(Pedidos pedidos) {
		return getService().deletePedidos(pedidos);
	}
	...
	public static Pedidos fetchPedidos(long id) {
		return getService().fetchPedidos(id);
	}

	public static List<Pedidos> findByOrder(long idUsuario, long idProducto) {
		return getService().findByOrder(idUsuario, idProducto);
	}

	public static List<Pedidos> findByUser(long idUsuario) {
		return getService().findByUser(idUsuario);
	}
	 ...
	 * @throws PortalException if a pedidos with the primary key could not be found
	 */
	public static Pedidos getPedidos(long id) throws PortalException {
		return getService().getPedidos(id);
	}
	 ...
	 */
	public static List<Pedidos> getPedidoses(int start, int end) {
		return getService().getPedidoses(start, end);
	}
	 ...
	 */
	public static int getPedidosesCount() {
		return getService().getPedidosesCount();
	}
	 ...
	 */
	public static Pedidos updatePedidos(Pedidos pedidos) {
		return getService().updatePedidos(pedidos);
	}

	public static PedidosLocalService getService() {
		return _service;
	}

	private static volatile PedidosLocalService _service;
