...
@Component(immediate = true, property = { "javax.portlet.name=" + PedidoFormPortletKeys.PEDIDOFORM,
		"mvc.command.name=/pedido/ciudad" }, service = MVCResourceCommand.class)
public class SelectCiudadResourceCommand implements MVCResourceCommand {

	private static final Log _log = LogFactoryUtil.getLog(SelectCiudadResourceCommand.class);
