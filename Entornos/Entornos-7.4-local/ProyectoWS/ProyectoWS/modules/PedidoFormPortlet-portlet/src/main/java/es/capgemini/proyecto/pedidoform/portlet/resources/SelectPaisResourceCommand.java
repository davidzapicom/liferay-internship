...
@Component(immediate = true, property = { "javax.portlet.name=" + PedidoFormPortletKeys.PEDIDOFORM,
		"mvc.command.name=/pedido/pais" }, service = MVCResourceCommand.class)
public class SelectPaisResourceCommand implements MVCResourceCommand {

	private static final Log _log = LogFactoryUtil.getLog(SelectPaisResourceCommand.class);
