...
@Component(
    ...
    property = {
        ...
        "mvc.command.name=/select/pais"
    },
    service = MVCResourceCommand.class
)
public class SelecPaisResourceCommand implements MVCResourceCommand {
   @Override
...
//        jSONArrayObject
    ...
    private static final Log _log = LogFactoryUtil.getLog(SelecPaisResourceCommand.class);
}