...
/**
 * Provides the local service utility for Tienda. This utility wraps
 * <code>es.capgemini.practicas.sb.tienda.service.impl.TiendaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TiendaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>es.capgemini.practicas.sb.tienda.service.impl.TiendaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Tienda addTienda(Tienda tienda) {
		return getService().addTienda(tienda);
	}
	 ...
	 */
	public static Tienda createTienda(long id) {
		return getService().createTienda(id);
	}
	 ...
	 */
	public static Tienda deleteTienda(long id) throws PortalException {
		return getService().deleteTienda(id);
	}
	 ...
	 * @return the tienda that was removed
	 */
	public static Tienda deleteTienda(Tienda tienda) {
		return getService().deleteTienda(tienda);
	}
	...
	public static Tienda fetchTienda(long id) {
		return getService().fetchTienda(id);
	}

	public static List<Tienda> findByLoc(String pais, String provincia) {
		return getService().findByLoc(pais, provincia);
	}

	public static List<Tienda> findByName(String nombre) {
		return getService().findByName(nombre);
	}
	 ...
	 * @throws PortalException if a tienda with the primary key could not be found
	 */
	public static Tienda getTienda(long id) throws PortalException {
		return getService().getTienda(id);
	}
	 ...
	 */
	public static List<Tienda> getTiendas(int start, int end) {
		return getService().getTiendas(start, end);
	}
	 ...
	 */
	public static int getTiendasCount() {
		return getService().getTiendasCount();
	}
	 ...
	 */
	public static Tienda updateTienda(Tienda tienda) {
		return getService().updateTienda(tienda);
	}

	public static TiendaLocalService getService() {
		return _service;
	}

	private static volatile TiendaLocalService _service;
