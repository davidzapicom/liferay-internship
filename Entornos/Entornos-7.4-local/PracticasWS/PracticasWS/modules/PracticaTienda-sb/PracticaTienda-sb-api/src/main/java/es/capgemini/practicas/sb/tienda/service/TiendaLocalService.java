...
/**
 * Provides the local service interface for Tienda. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TiendaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TiendaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>es.capgemini.practicas.sb.tienda.service.impl.TiendaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tienda local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TiendaLocalServiceUtil} if injection and service tracking are not available.
	 */
