...
if (
 ...
 GroupPermissionUtil.contains(permissionChecker, group.getGroupId(), ActionKeys.UPDATE) ) {
      out.write("\n");
      out.write("\t\t");
      //  portlet:renderURL
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("inviteMembersButton.addEventListener('click', (event) => {\n");
          out.write("\t\t\t\tLiferay.Util.openWindow({\n");
          out.write("\t\t\t\t\tdialog: {\n");
          out.write("\t\t\t\t\t\tcssClass: 'so-portlet-invite-members',\n");
  ...
  private boolean _jspx_meth_aui_a_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_a_0.setCssClass("btn btn-secondary");
  ...
  private boolean _jspx_meth_aui_script_1(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\t\t\tvar portlet = document.getElementById('p_p_id");
        ...
        out.write("\t\t\t\tportlet.classList.add('hide');\n");
        out.write("\t\t\t}\n");
        out.write("\t\t");
