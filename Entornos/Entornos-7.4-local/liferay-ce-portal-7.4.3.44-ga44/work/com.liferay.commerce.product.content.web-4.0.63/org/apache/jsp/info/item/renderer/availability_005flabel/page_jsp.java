package org.apache.jsp.info.item.renderer.availability_005flabel;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/info/item/renderer/availability_label/init.jsp");
  }
...
String namespace = (String)request.getAttribute("liferay-commerce:availability-label:namespace");
      ...
      out.print( Validator.isNull(label) ? "invisible" + StringPool.SPACE : StringPool.BLANK );
      out.write("label label-");
      out.print( labelType );
      out.write(" m-0 ");
      out.print( namespace );
      out.write("availability-label\">\n");
...
if (
 Validator.isNotNull(namespace) ) {
      ...
      _jspx_th_liferay$1frontend_component_0.setModule("info/item/renderer/availability_label/js/AvailabilityCPInstanceChangeHandler");
