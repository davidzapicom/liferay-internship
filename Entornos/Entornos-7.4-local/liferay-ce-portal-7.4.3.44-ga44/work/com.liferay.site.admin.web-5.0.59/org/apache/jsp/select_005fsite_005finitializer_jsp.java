...
renderResponse.setTitle(LanguageUtil.get(request, "select-site-template"));
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_search$1container_0.setSearchContainer( selectSiteInitializerDisplayContext.getSearchContainer() );
        ...
        if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_search$1container$1row_0.setClassName("com.liferay.site.admin.web.internal.util.SiteInitializerItem");
          ...
          if (_jspx_eval_liferay$1ui_search$1container$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            com.liferay.site.admin.web.internal.util.SiteInitializerItem siteInitializerItem = null;
            ...
            siteInitializerItem = (com.liferay.site.admin.web.internal.util.SiteInitializerItem) _jspx_page_context.findAttribute("siteInitializerItem");
            ...
            do {
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\n");
                  out.write("\t\t\t\t<button class=\"add-site-action-button align-items-stretch btn btn-unstyled form-check-card mb-4 w-100\" type=\"button\">\n");
                  out.write("\t\t\t\t\t");
                  //  clay:vertical-card
                  ...
                  _jspx_th_clay_vertical$1card_0.setVerticalCard( new SelectSiteInitializerVerticalCard(siteInitializerItem, renderRequest, renderResponse) );
        ...
        _jspx_th_portlet_actionURL_0.setName("/site_admin/add_group");
        ...
        if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_param_1.setName("parentGroupId");
          _jspx_th_portlet_param_1.setValue( String.valueOf(selectSiteInitializerDisplayContext.getParentGroupId()) );
  ...
  private boolean _jspx_meth_aui_script_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_script_0.setRequire("frontend-js-web/liferay/delegate/delegate.es as delegateModule,frontend-js-web/liferay/modal/commands/OpenSimpleInputModal.es as openSimpleInputModal");
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\n");
        out.write("\t\tvar addSiteActionOptionQueryClickHandler = delegate(\n");
        out.write("\t\t\tdocument.body,\n");
        out.write("\t\t\t'click',\n");
        out.write("\t\t\t'.add-site-action-button',\n");
        out.write("\t\t\t(event) => {\n");
        out.write("\t\t\t\tvar data = event.delegateTarget.querySelector('.add-site-action-card')\n");
        out.write("\t\t\t\t\t.dataset;\n");
        out.write("\n");
        ...
        if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("',\n");
        out.write("\t\t\t\t\turl: data.addSiteUrl,\n");
        out.write("\t\t\t\t});\n");
        out.write("\t\t\t}\n");
        out.write("\t\t);\n");
        out.write("\n");
        out.write("\t\tfunction handleDestroyPortlet() {\n");
        out.write("\t\t\taddSiteActionOptionQueryClickHandler.dispose();\n");
        out.write("\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("add-site");
