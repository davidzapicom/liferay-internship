 ...
 Objects.equals(siteAdminDisplayContext.getDisplayStyle(), "icon") ) {
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                _jspx_th_clay_vertical$1card_0.setPropsTransformer("js/SiteDropdownDefaultPropsTransformer");
...
if (
 PropsValues.LIVE_USERS_ENABLED ) {
            ...
            _jspx_th_liferay$1ui_search$1container$1column$1text_8.setCssClass("table-cell-expand-smallest table-cell-ws-nowrap table-column-text-center");
