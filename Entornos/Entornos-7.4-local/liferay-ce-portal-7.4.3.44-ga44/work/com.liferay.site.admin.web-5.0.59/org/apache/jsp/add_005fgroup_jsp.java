...
AddGroupDisplayContext addGroupDisplayContext = (AddGroupDisplayContext)request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"add-group-alert-container\"></div>\n");
      out.write("\n");
      ...
      if (_jspx_eval_clay_container$1fluid_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1frontend_edit$1form_0.setCssClass("add-group-form pt-0");
...
if (
 addGroupDisplayContext.isShowLayoutSetVisibilityPrivateCheckbox() ) {
          out.write("\n");
          out.write("\t\t\t\t\t");
          if (_jspx_meth_aui_input_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1frontend_edit$1form_0, _jspx_page_context))
            return;
          out.write("\n");
          out.write("\t\t\t\t");
}
...
if (
 addGroupDisplayContext.hasRequiredVocabularies() ) {
          ...
          _jspx_th_aui_fieldset_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_edit$1form_0);
...
if (
 addGroupDisplayContext.isShowCategorization() ) {
  ...
  private boolean _jspx_meth_aui_input_1(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_edit$1form_0, PageContext _jspx_page_context)
          throws Throwable {
