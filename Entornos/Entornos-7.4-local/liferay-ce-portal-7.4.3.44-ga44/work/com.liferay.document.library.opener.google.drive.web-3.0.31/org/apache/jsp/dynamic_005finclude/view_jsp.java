...
DLOpenerGoogleDriveFileReference dlOpenerGoogleDriveFileReference = (DLOpenerGoogleDriveFileReference)request.getAttribute(DLOpenerGoogleDriveWebKeys.DL_OPENER_GOOGLE_DRIVE_FILE_REFERENCE);
      ...
      out.write('\n');
if (
 dlOpenerGoogleDriveFileReference != null ) {
      out.write('\n');
      out.write('	');
      //  portlet:resourceURL
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\t\t\tthrow defaultError;\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\t\treturn response.json();\n");
          out.write("\t\t\t\t\t})\n");
          out.write("\t\t\t\t\t.then((response) => {\n");
          out.write("\t\t\t\t\t\tif (response.complete) {\n");
          out.write("\t\t\t\t\t\t\turl = response.googleDocsEditURL;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tnavigate();\n");
          out.write("\t\t\t\t\t\t}\n");
          ...
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\t\tsetTimeout(polling, TIME_POLLING);\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t})\n");
          out.write("\t\t\t\t\t.catch((error) => {\n");
          out.write("\t\t\t\t\t\tshowError(error);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tLiferay.Util.getWindow(dialogId).hide();\n");
          out.write("\t\t\t\t\t});\n");
          out.write("\t\t\t}\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\tcssClass: 'google-docs-redirect-modal',\n");
          out.write("\t\t\t\t\t\theight: 172,\n");
          ...
          out.write("\t\t\t\t\t\tisTimeConsumed = true;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tnavigate();\n");
          out.write("\t\t\t\t\t}, TIME_SHOW_MSG);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\t\t})();\n");
          out.write("\t");
      ...
      if (_jspx_eval_liferay$1util_html$1top_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t<link href=\"");
          out.print( HtmlUtil.escapeAttribute(PortalUtil.getStaticResourceURL(request, StringBundler.concat(themeDisplay.getCDNBaseURL(), PortalUtil.getPathProxy(), application.getContextPath(), "/css/document_library.css"))) );
