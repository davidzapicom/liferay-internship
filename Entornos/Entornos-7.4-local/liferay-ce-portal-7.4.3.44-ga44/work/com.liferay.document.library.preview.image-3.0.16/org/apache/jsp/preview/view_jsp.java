package org.apache.jsp.preview;
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/preview/init.jsp");
...
String previewURL = DLURLHelperUtil.getPreviewURL(fileVersion.getFileEntry(), fileVersion, themeDisplay, previewQueryString);
      ...
      _jspx_th_liferay$1util_html$1top_0.setOutputKey("document_library_preview_image_css");
      ...
      if (_jspx_eval_liferay$1util_html$1top_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t<link href=\"");
          out.print( PortalUtil.getStaticResourceURL(request, PortalUtil.getPathProxy() + application.getContextPath() + "/preview/css/main.css") );
      ...
      out.write('	');
if (
 Objects.equals(fileVersion.getMimeType(), ContentTypes.IMAGE_SVG_XML) ) {
      out.write("\n");
      out.write("\t\t<div class=\"preview-file\">\n");
      out.write("\t\t\t<div class=\"preview-file-container preview-file-max-height\">\n");
      out.write("\t\t\t\t<img alt=\"");
      out.print( HtmlUtil.escapeAttribute(fileVersion.getDescription()) );
      out.write("\" class=\"preview-file-image-vectorial\" src=\"");
      ...
      _jspx_th_react_component_0.setModule("preview/js/ImagePreviewer.es");
