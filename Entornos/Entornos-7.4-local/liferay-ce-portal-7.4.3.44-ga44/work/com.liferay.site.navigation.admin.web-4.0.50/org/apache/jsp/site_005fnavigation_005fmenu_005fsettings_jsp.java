...
SiteNavigationMenu siteNavigationMenu = siteNavigationAdminDisplayContext.getSiteNavigationMenu();
      ...
      _jspx_th_portlet_actionURL_0.setName("/site_navigation_admin/edit_site_navigation_menu_settings");
...
if (
 Validator.isNotNull(typeKey) ) {
        ...
        if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_3.setLabel("when-creating-a-new-page,-the-page-will-be-automatically-added-to-this-menu-unless-the-user-deselects-it");
