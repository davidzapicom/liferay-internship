  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_1.setLabel("allow-site-administrators-to-use-their-own-logo");
        _jspx_th_aui_input_1.setName( "settings--" + PropsKeys.COMPANY_SECURITY_SITE_LOGO + "--" );
        _jspx_th_aui_input_1.setType("checkbox");
        _jspx_th_aui_input_1.setValue( company.isSiteLogo() );
        ...
        _jspx_th_liferay$1ui_logo$1selector_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
      ...
      if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_select_0.setLabel("default-theme");
        _jspx_th_aui_select_0.setName( "settings--" + PropsKeys.DEFAULT_REGULAR_THEME_ID + "--" );
		...
		for (Theme curTheme : themes) {
            ...
            _jspx_th_aui_option_0.setLabel( curTheme.getName() );
            _jspx_th_aui_option_0.setSelected( Objects.equals(defaultRegularThemeId, curTheme.getThemeId()) );
            _jspx_th_aui_option_0.setValue( curTheme.getThemeId() );
...
if (
 !deployed ) {
            ...
            _jspx_th_aui_option_1.setLabel( defaultRegularThemeId + "(" + LanguageUtil.get(request, "undeployed") + ")" );
            _jspx_th_aui_option_1.setSelected( true );
            _jspx_th_aui_option_1.setValue( defaultRegularThemeId );
        ...
        _jspx_th_aui_select_1.setLabel("default-control-panel-theme");
        _jspx_th_aui_select_1.setName( "settings--" + PropsKeys.CONTROL_PANEL_LAYOUT_REGULAR_THEME_ID + "--" );
		...
		for (Theme curTheme : themes) {
            ...
            _jspx_th_aui_option_2.setLabel( curTheme.getName() );
            _jspx_th_aui_option_2.setSelected( Objects.equals(defaultControlPanelThemeId, curTheme.getThemeId()) );
            _jspx_th_aui_option_2.setValue( curTheme.getThemeId() );
...
if (
 !deployed ) {
            ...
            _jspx_th_aui_option_3.setLabel( defaultControlPanelThemeId + "(" + LanguageUtil.get(request, "undeployed") + ")" );
            _jspx_th_aui_option_3.setSelected( true );
            _jspx_th_aui_option_3.setValue( defaultControlPanelThemeId );
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("look-and-feel");
