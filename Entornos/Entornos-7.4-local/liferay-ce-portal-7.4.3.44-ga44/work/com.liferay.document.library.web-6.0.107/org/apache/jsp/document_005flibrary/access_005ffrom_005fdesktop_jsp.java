...
DLAccessFromDesktopDisplayContext dlAccessFromDesktopDisplayContext = new DLAccessFromDesktopDisplayContext(request);
      ...
      _jspx_th_liferay$1ui_icon_0.setCssClass( dlAccessFromDesktopDisplayContext.getRandomNamespace() + "-webdav-action" );
      ...
      out.write("\n");
      out.write("<div id=\"");
      out.print( dlAccessFromDesktopDisplayContext.getRandomNamespace() );
      ...
      _jspx_th_liferay$1ui_message_0.setKey( dlAccessFromDesktopDisplayContext.getWebDAVHelpMessage() );
      ...
      out.write("\n");
      out.write("\t\t");
      if (_jspx_meth_liferay$1learn_message_0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("\n");
      out.write("\t\t<br /><br />\n");
      ...
      _jspx_th_aui_input_0.setId( dlAccessFromDesktopDisplayContext.getRandomNamespace() + "webDavURL" );
      _jspx_th_aui_input_0.setName("webDavURL");
      _jspx_th_aui_input_0.setType("resource");
      _jspx_th_aui_input_0.setValue( dlAccessFromDesktopDisplayContext.getWebDAVURL() );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t(function () {\n");
          out.write("\t\tvar webdavContentContainer = document.getElementById(\n");
          out.write("\t\t\t'");
          out.print( dlAccessFromDesktopDisplayContext.getRandomNamespace() );
          out.write("webDav'\n");
          out.write("\t\t);\n");
          ...
          out.write("\t\tvar html = '';\n");
          out.write("\n");
          out.write("\t\tif (webdavContentContainer) {\n");
          out.write("\t\t\thtml = webdavContentContainer.innerHTML;\n");
          out.write("\n");
          out.write("\t\t\twebdavContentContainer.remove();\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tvar webdavActionLink = document.querySelector(\n");
          out.write("\t\t\t'.");
          out.print( dlAccessFromDesktopDisplayContext.getRandomNamespace() );
          out.write("-webdav-action'\n");
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tif (webdavActionLink) {\n");
          out.write("\t\t\twebdavActionLink.addEventListener('click', (event) => {\n");
          out.write("\t\t\t\tevent.preventDefault();\n");
          out.write("\n");
          out.write("\t\t\t\tif (webdavContentContainer) {\n");
          out.write("\t\t\t\t\tLiferay.Util.openModal({\n");
          out.write("\t\t\t\t\t\tbodyHTML: html,\n");
          out.write("\t\t\t\t\t\tonOpen: function (event) {\n");
          out.write("\t\t\t\t\t\t\tvar webdavURLInput = document.getElementById(\n");
          out.write("\t\t\t\t\t\t\t\t'");
  ...
  private boolean _jspx_meth_liferay$1learn_message_0(PageContext _jspx_page_context)
          throws Throwable {
    ...
    _jspx_th_liferay$1learn_message_0.setParent(null);
    _jspx_th_liferay$1learn_message_0.setKey("webdav");
    _jspx_th_liferay$1learn_message_0.setResource("document-library-web");
