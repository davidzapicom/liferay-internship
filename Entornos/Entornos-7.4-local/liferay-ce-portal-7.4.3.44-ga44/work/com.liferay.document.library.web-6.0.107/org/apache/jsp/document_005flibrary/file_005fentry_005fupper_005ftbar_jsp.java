...
public final class file_005fentry_005fupper_005ftbar_jsp extends org.apache.jasper.runtime.HttpJspBase
...
FileVersion fileVersion = dlViewFileEntryDisplayContext.getFileVersion();
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"upper-tbar-container-fixed\">\n");
      out.write("\t<div class=\"tbar upper-tbar\">\n");
      out.write("\t\t");
      ...
      if (_jspx_eval_clay_container$1fluid_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t\t\t\t<div class=\"tbar-section text-left\">\n");
        out.write("\t\t\t\t\t\t<h2 class=\"text-truncate-inline upper-tbar-title\" title=\"");
        out.print( HtmlUtil.escapeAttribute(dlViewFileEntryDisplayContext.getDocumentTitle()) );
        out.write("\">\n");
        out.write("\t\t\t\t\t\t\t<span class=\"text-truncate\">");
        out.print( HtmlUtil.escape(dlViewFileEntryDisplayContext.getDocumentTitle()) );
        out.write("</span>\n");
        out.write("\t\t\t\t\t\t</h2>\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t");
if (
 fileEntry.hasLock() || fileEntry.isCheckedOut() ) {
        ...
        out.write("\t\t\t\t\t\t\t\t");
        if (_jspx_meth_aui_icon_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_clay_container$1fluid_0, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t\t\t\t</span>\n");
        out.write("\t\t\t\t\t\t");
        ...
        out.write("\t\t\t\t\t\t");
if (
 dlViewFileEntryDisplayContext.isShared() ) {
        out.write("\n");
        ...
        out.write("\">\n");
        out.write("\t\t\t\t\t\t\t\t");
        if (_jspx_meth_aui_icon_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_clay_container$1fluid_0, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t\t\t\t</span>\n");
        out.write("\t\t\t\t\t\t");
        ...
        _jspx_th_clay_button_0.setDynamicAttribute(null, "data-qa-id", new String("infoButton"));
        _jspx_th_clay_button_0.setDisplayType("secondary");
        _jspx_th_clay_button_0.setIcon("info-circle-open");
        _jspx_th_clay_button_0.setId( liferayPortletResponse.getNamespace() + "OpenContextualSidebar" );
        _jspx_th_clay_button_0.setSmall( true );
        _jspx_th_clay_button_0.setDynamicAttribute(null, "title",  LanguageUtil.get(resourceBundle, "info") );
        ...
        out.write("\t\t\t\t");
if (
 dlViewFileEntryDisplayContext.isSharingLinkVisible() ) {
        out.write("\n");
        out.write("\t\t\t\t\t<li class=\"d-none d-sm-flex tbar-item\">\n");
        out.write("\t\t\t\t\t\t");
        ...
        _jspx_th_liferay$1sharing_button_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_0);
        ...
        out.write("\t\t\t\t");
if (
 dlViewFileEntryDisplayContext.isDownloadLinkVisible() ) {
        out.write("\n");
        out.write("\t\t\t\t\t<li class=\"d-none d-sm-flex tbar-item\">\n");
        out.write("\t\t\t\t\t\t");
        //  clay:link
        ...
        _jspx_th_clay_link_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_0);
        ...
        _jspx_th_clay_link_0.setIcon("download");
        ...
        _jspx_th_clay_dropdown$1actions_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_0);
        _jspx_th_clay_dropdown$1actions_0.setDropdownItems( dlViewFileEntryDisplayContext.getActionDropdownItems() );
        _jspx_th_clay_dropdown$1actions_0.setPropsTransformer("document_library/js/DLFileEntryDropdownPropsTransformer");
  ...
  private boolean _jspx_meth_aui_icon_0(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_container$1fluid_0, PageContext _jspx_page_context)
          throws Throwable {
    ...
    _jspx_th_aui_icon_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_0);
  ...
  private boolean _jspx_meth_aui_icon_1(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_container$1fluid_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:icon
    ...
    _jspx_th_aui_icon_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_0);
    _jspx_th_aui_icon_1.setImage("users");
    _jspx_th_aui_icon_1.setMarkupView("lexicon");
    _jspx_th_aui_icon_1.setDynamicAttribute(null, "message", new String("shared"));
