...
boolean emailFileEntryAnyEventEnabled = dlGroupServiceSettings.isEmailFileEntryAddedEnabled() || dlGroupServiceSettings.isEmailFileEntryUpdatedEnabled();
      ...
      out.write('\n');
if (
 DLFolderPermission.contains(permissionChecker, scopeGroupId, folderId, ActionKeys.SUBSCRIBE) && ((folder == null) || folder.isSupportsSubscribing()) && emailFileEntryAnyEventEnabled ) {
      out.write("\n");
      out.write("\n");
      out.write("\t");
...
if (
 unsubscribable ) {
      ...
      _jspx_th_portlet_actionURL_0.setName( (fileEntryTypeId == DLFileEntryTypeConstants.FILE_ENTRY_TYPE_ID_ALL) ? "/document_library/edit_folder" : "/document_library/unsubscribe_file_entry_type" );
      ...
      if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t\t\t\t\t\t");
if (
 fileEntryTypeId == DLFileEntryTypeConstants.FILE_ENTRY_TYPE_ID_ALL ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t");
        //  portlet:param
      ...
      _jspx_th_portlet_actionURL_1.setName( (fileEntryTypeId == DLFileEntryTypeConstants.FILE_ENTRY_TYPE_ID_ALL) ? "/document_library/edit_folder" : "/document_library/subscribe_file_entry_type" );
