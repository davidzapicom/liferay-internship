...
if (
 folderActionDisplayContext.isShowActions() ) {
      ...
      _jspx_th_clay_dropdown$1actions_0.setDropdownItems( folderActionDisplayContext.getActionDropdownItems() );
      _jspx_th_clay_dropdown$1actions_0.setPropsTransformer("document_library/js/DLFolderDropdownPropsTransformer");
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\tvar uploadMultipleDocumentsIcon = A.all(\n");
        out.write("\t\t\t\t'.upload-multiple-documents:hidden'\n");
        out.write("\t\t\t);\n");
        out.write("\n");
