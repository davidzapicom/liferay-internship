...
if (
 fileVersion.isApproved() ) {
      ...
      out.write("\t\t\t");
if (
 Validator.isNotNull(previewURL) ) {
      out.write("\n");
      out.write("\t\t\t\t<div class=\"aspect-ratio aspect-ratio-8-to-3 aspect-ratio-bg-cover cover-image mb-4\" style=\"background-image: url(");
      ...
      out.write("\n");
      out.write("\t\t\t\t<div class=\"aspect-ratio aspect-ratio-8-to-3 bg-light mb-4\">\n");
      out.write("\t\t\t\t\t<div class=\"aspect-ratio-item-center-middle aspect-ratio-item-fluid card-type-asset-icon\">\n");
      out.write("\t\t\t\t\t\t<div class=\"text-secondary\">\n");
      out.write("\t\t\t\t\t\t\t<svg aria-hidden=\"true\" class=\"h4 lexicon-icon reference-mark\">\n");
      out.write("\t\t\t\t\t\t\t\t<use xlink:href=\"");
      out.print( FrontendIconsUtil.getSpritemap(themeDisplay) );
      out.write('#');
      out.print( assetRenderer.getIconCssClass() );
      out.write("\" />\n");
      out.write("\t\t\t\t\t\t\t</svg>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\n");
      out.write("\t\t");
      out.print( HtmlUtil.replaceNewLine(HtmlUtil.escape(StringUtil.shorten(fileEntry.getDescription(), abstractLength))) );
      out.write("\n");
      out.write("\t</div>\n");
}
    } catch (Throwable t) {
