...
DLRequestHelper dlRequestHelper = new DLRequestHelper(request);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<ul class=\"list-group sidebar-list-group\">\n");
      out.write("\n");
      out.write("\t");
	...
	for (FileVersion fileVersion : fileEntry.getFileVersions(status)) {
      ...
      _jspx_th_clay_content$1col_0.setParent(null);
      ...
      if (_jspx_eval_clay_content$1col_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n");
        out.write("\t\t\t\t<div class=\"list-group-title\">\n");
        out.write("\t\t\t\t\t");
        //  liferay-ui:message
        ...
        out.write("\t\t\t\t</div>\n");
        out.write("\n");
        out.write("\t\t\t\t<div class=\"list-group-subtitle\">\n");
        out.write("\t\t\t\t\t");
        //  liferay-ui:message
        ...
        _jspx_th_liferay$1ui_message_1.setArguments( new Object[] {HtmlUtil.escape(fileVersion.getUserName()), dateFormatDateTime.format(fileVersion.getCreateDate())} );
        ...
        out.write("\t\t\t\t</div>\n");
        out.write("\n");
        out.write("\t\t\t\t<div class=\"list-group-subtext\">\n");
        out.write("\t\t\t\t\t");
        out.write("\n");
        out.write("\t\t\t\t\t\t");
if (
 Validator.isNull(fileVersion.getChangeLog()) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t");
        ...
        out.write("\n");
        out.write("\t\t\t\t\t\t\t");
        out.print( HtmlUtil.escape(fileVersion.getChangeLog()) );
        out.write("\n");
        out.write("\t\t\t\t\t\t");
        out.write("\n");
        out.write("\t\t\t\t\t");
      ...
      _jspx_th_clay_content$1col_1.setParent(null);
      ...
      if (_jspx_eval_clay_content$1col_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_clay_dropdown$1actions_0.setDropdownItems( dlViewFileEntryHistoryDisplayContext.getActionDropdownItems() );
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_content$1col_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("no-change-log");
