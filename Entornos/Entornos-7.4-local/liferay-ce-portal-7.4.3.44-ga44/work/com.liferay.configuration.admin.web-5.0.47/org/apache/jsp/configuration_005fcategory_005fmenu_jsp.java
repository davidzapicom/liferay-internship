...
ConfigurationCategoryMenuDisplay configurationCategoryMenuDisplay = (ConfigurationCategoryMenuDisplay)request.getAttribute(ConfigurationAdminWebKeys.CONFIGURATION_CATEGORY_MENU_DISPLAY);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<nav class=\"menubar menubar-transparent menubar-vertical-expand-md\">\n");
      ...
      out.write("\t\t\t\t\t<a class=\"nav-link text-uppercase\">\n");
      out.write("\t\t\t\t\t\t");
      //  liferay-ui:message
      ...
      _jspx_th_aui_a_0.setCssClass( configurationEntry.equals(curConfigurationEntry) ? "active nav-link" : "nav-link" );
