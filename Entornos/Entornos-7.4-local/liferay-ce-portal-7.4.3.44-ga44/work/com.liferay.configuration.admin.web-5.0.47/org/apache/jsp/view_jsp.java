...
ConfigurationScopeDisplayContext configurationScopeDisplayContext = ConfigurationScopeDisplayContextFactory.create(renderRequest);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"sticky-top\" style=\"top: 56px; z-index: 999;\">\n");
      out.write("\t");
      ...
      if (_jspx_eval_liferay$1ui_success_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write('\n');
          out.write('	');
          if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ui_success_0, _jspx_page_context))
            return;
          out.write('\n');
...
if (
 configurationCategorySectionDisplays.isEmpty() ) {
        ...
        out.write("\t\t\t\t<p class=\"list-group-header-title text-uppercase\">\n");
        out.write("\t\t\t\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ui_success_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_success_0);
    _jspx_th_liferay$1ui_message_0.setKey("site-was-successfully-added");
