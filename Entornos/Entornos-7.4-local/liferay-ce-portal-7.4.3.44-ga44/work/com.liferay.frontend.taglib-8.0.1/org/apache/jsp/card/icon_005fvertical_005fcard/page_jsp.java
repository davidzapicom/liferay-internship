...
String url = (String)request.getAttribute("liferay-frontend:card:url");
      ...
      if (_jspx_eval_liferay$1util_html$1top_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t<link href=\"");
          out.print( PortalUtil.getStaticResourceURL(request, PortalUtil.getPathProxy() + application.getContextPath() + "/css/card.css") );
...
String title = (String)request.getAttribute("liferay-frontend:card:title");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"card-type-asset ");
      out.print( Validator.isNotNull(cssClass) ? cssClass : StringPool.BLANK );
      out.write(' ');
      out.print( showCheckbox ? "form-check form-check-card form-check-top-left" : StringPool.BLANK );
      out.write('"');
      out.write(' ');
      out.print( AUIUtil.buildData(data) );
      out.write(">\n");
      out.write("\t<div class=\"card ");
      out.print( Validator.isNotNull(cardCssClass) ? cardCssClass : StringPool.BLANK );
      out.write("\">\n");
 ...
 (rowChecker != null) && (resultRow != null) ) {
      ...
      if (_jspx_eval_liferay$1util_buffer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\t\t\t\t");
          out.print( rowChecker.getRowCheckBox(request, resultRow) );
          out.write("\n");
          out.write("\t\t\t\t");
      ...
      _jspx_th_aui_icon_0.setCssClass("aspect-ratio-item-center-middle aspect-ratio-item-fluid card-type-asset-icon");
...
if (
 Validator.isNotNull(title) ) {
      ...
      _jspx_th_aui_a_0.setCssClass("card-title text-truncate");
...
if (
 Validator.isNotNull(header) ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"card-subtitle text-truncate\">\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print( header );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
