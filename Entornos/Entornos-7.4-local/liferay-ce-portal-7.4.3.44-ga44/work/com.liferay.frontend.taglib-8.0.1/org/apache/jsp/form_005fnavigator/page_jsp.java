...
if (
 categoryKeys.length > 1 ) {
      ...
      _jspx_th_liferay$1ui_tabs_0.setParam( formNavigatorDisplayContext.getTabs1Param() );
      _jspx_th_liferay$1ui_tabs_0.setRefresh( false );
      _jspx_th_liferay$1ui_tabs_0.setValue( GetterUtil.getString(SessionClicks.get(request, namespace + formNavigatorDisplayContext.getId(), null)) );
      ...
      out.write('\n');
if (
 formNavigatorDisplayContext.isShowButtons() ) {
      out.write("\n");
      out.write("\t<div>\n");
      out.write("\t\t");
      //  aui:button
      ...
      _jspx_th_aui_button_1.setHref( formNavigatorDisplayContext.getBackURL() );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar redirectField = document.querySelector(\n");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar tabs1Param = '");
          out.print( formNavigatorDisplayContext.getTabs1Param() );
          out.write("';\n");
          out.write("\n");
          out.write("\tvar updateRedirectField = function (event) {\n");
          out.write("\t\tvar redirectURL = new URL(redirectField.value, window.location.origin);\n");
          out.write("\n");
          out.write("\t\tredirectURL.searchParams.set(tabs1Param, event.id);\n");
          out.write("\n");
          out.write("\t\tredirectField.value = redirectURL.toString();\n");
          out.write("\n");
          out.write("\t\tLiferay.Util.Session.set(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.print( formNavigatorDisplayContext.getId() );
          out.write("',\n");
          out.write("\t\t\tevent.id\n");
          out.write("\t\t);\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar clearFormNavigatorHandles = function (event) {\n");
          out.write("\t\tif (event.portletId === '");
          out.print( portletDisplay.getRootPortletId() );
          out.write("') {\n");
          out.write("\t\t\tLiferay.detach('showTab', updateRedirectField);\n");
          out.write("\t\t\tLiferay.detach('destroyPortlet', clearFormNavigatorHandles);\n");
          out.write("\t\t}\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tif (redirectField) {\n");
          out.write("\t\tvar currentURL = new URL(document.location.href);\n");
          out.write("\n");
          out.write("\t\tvar tabs1Value = currentURL.searchParams.get(tabs1Param);\n");
          out.write("\n");
          out.write("\t\tif (tabs1Value) {\n");
          out.write("\t\t\tupdateRedirectField({\n");
          out.write("\t\t\t\tid: tabs1Value,\n");
          out.write("\t\t\t});\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tLiferay.on('showTab', updateRedirectField);\n");
          out.write("\t\tLiferay.on('destroyPortlet', clearFormNavigatorHandles);\n");
          out.write("\t}\n");
