...
boolean emailAssetEntryAddedEnabled = ParamUtil.getBoolean(request, "preferences--emailAssetEntryAddedEnabled--", assetPublisherWebHelper.getEmailAssetEntryAddedEnabled(portletPreferences));
      ...
      com.liferay.frontend.taglib.servlet.taglib.EmailNotificationSettingsTag _jspx_th_liferay$1frontend_email$1notification$1settings_0 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.frontend.taglib.servlet.taglib.EmailNotificationSettingsTag.class) : new com.liferay.frontend.taglib.servlet.taglib.EmailNotificationSettingsTag();
      ...
      _jspx_th_liferay$1frontend_email$1notification$1settings_0.setEmailBodyLocalizedValuesMap( assetPublisherDisplayContext.getEmailAssetEntryAddedBody() );
      _jspx_th_liferay$1frontend_email$1notification$1settings_0.setEmailDefinitionTerms( assetPublisherWebHelper.getEmailDefinitionTerms(renderRequest, emailFromAddress, emailFromName) );
      ...
      _jspx_th_liferay$1frontend_email$1notification$1settings_0.setEmailSubjectLocalizedValuesMap( assetPublisherDisplayContext.getEmailAssetEntryAddedSubject() );
      ...
      if (_jspx_th_liferay$1frontend_email$1notification$1settings_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1frontend_email$1notification$1settings_0);
        _jspx_th_liferay$1frontend_email$1notification$1settings_0.release();
        return;
      }
      if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1frontend_email$1notification$1settings_0);
      _jspx_th_liferay$1frontend_email$1notification$1settings_0.release();
