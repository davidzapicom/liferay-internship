...
Format dateFormatDate = FastDateFormatFactoryUtil.getDate(locale, timeZone);
      ...
      if (_jspx_eval_clay_row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_clay_col_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_select_0.setValue( assetPublisherDisplayContext.getOrderByColumn1() );
          ...
          if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              out.write("\t\t\t");
if (
 assetPublisherDisplayContext.isOrderingByTitleEnabled() ) {
              out.write("\n");
              out.write("\t\t\t\t");
              ...
              out.write("\t\t\t");
if (
 !assetPublisherDisplayContext.isSearchWithIndex() ) {
              out.write("\n");
              out.write("\t\t\t\t");
