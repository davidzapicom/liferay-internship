...
if (
 assetPublisherViewContentDisplayContext.isAssetEntryVisible() ) {
      ...
      _jspx_th_liferay$1util_include_0.setPage("/view_asset_entry_full_content.jsp");
      ...
      _jspx_th_liferay$1util_include_1.setPage("/error.jsp");
      ...
      out.write('\n');
if (
 assetPublisherDisplayContext.isEnabledAutoscroll() ) {
      out.write('\n');
      out.write('	');
      //  aui:script
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\tLiferay.once('allPortletsReady', () => {\n");
          out.write("\t\t\tdocument\n");
          out.write("\t\t\t\t.getElementById('p_p_id_");
