...
public final class view_005fasset_005fentry_005ffull_005fcontent_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Map<String, Object> fragmentsEditorData = HashMapBuilder.<String, Object>put(
	...
	"fragments-editor-item-type", "fragments-editor-mapped-item"
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"asset-full-content clearfix mb-5 ");
	...
	request.setAttribute("view.jsp-fullContentRedirect", fullContentRedirect);
      ...
      out.write("\t");
if (
 (showBackURL && Validator.isNotNull(redirect)) || assetPublisherDisplayContext.isShowAssetTitle() || (!print && Validator.isNotNull(assetActions)) ) {
      out.write("\n");
      out.write("\t\t<div class=\"align-items-center d-flex mb-2\">\n");
      out.write("\t\t\t<p class=\"component-title h4\">\n");
      out.write("\t\t\t\t");
if (
 showBackURL && Validator.isNotNull(redirect) ) {
      out.write("\n");
      out.write("\t\t\t\t\t");
      //  liferay-ui:icon
      ...
      _jspx_th_liferay$1ui_icon_0.setMessage("back");
      ...
      out.write("\t\t\t\t");
if (
 assetPublisherDisplayContext.isShowAssetTitle() ) {
      out.write("\n");
...
if (
 assetPublisherDisplayContext.isShowAuthor() ) {
        ...
        if (_jspx_eval_clay_content$1col_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_user$1portrait_0.setSize("lg");
...
if (
 assetPublisherDisplayContext.isEnableRelatedAssets() ) {
	...
	boolean showRatings = assetPublisherDisplayContext.isEnableRatings() && assetRenderer.isRatable();
      ...
      out.write("\t");
if (
 showContextLink || showRatings || assetPublisherDisplayContext.isEnableFlags() || assetPublisherDisplayContext.isEnablePrint() || Validator.isNotNull(assetPublisherDisplayContext.getSocialBookmarksTypes()) ) {
      out.write("\n");
...
if (
 showContextLink ) {
        ...
        _jspx_th_clay_content$1col_2.setCssClass("asset-more mr-3");
        ...
        if (_jspx_eval_clay_content$1col_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_2);
          _jspx_th_liferay$1ui_message_2.setKey( assetRenderer.getViewInContextMessage() );
...
if (
 showRatings ) {
        ...
        _jspx_th_clay_content$1col_3.setCssClass("asset-ratings mr-3");
        ...
        if (_jspx_eval_clay_content$1col_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ratings_ratings_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_3);
...
if (
 assetPublisherDisplayContext.isEnableFlags() ) {
        ...
        _jspx_th_clay_content$1col_4.setCssClass("asset-flag mr-3");
        ...
        if (_jspx_eval_clay_content$1col_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1flags_flags_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_4);
...
if (
 assetPublisherDisplayContext.isEnablePrint() ) {
        ...
        _jspx_th_clay_content$1col_5.setCssClass("component-subtitle mr-3 print-action");
...
if (
 print ) {
          ...
          _jspx_th_liferay$1ui_icon_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_5);
          _jspx_th_liferay$1ui_icon_1.setIcon("print");
          _jspx_th_liferay$1ui_icon_1.setLinkCssClass("btn btn-monospaced btn-outline-borderless btn-outline-secondary btn-sm");
          _jspx_th_liferay$1ui_icon_1.setMarkupView("lexicon");
          _jspx_th_liferay$1ui_icon_1.setMessage( LanguageUtil.format(request, "print-x-x", new Object[] {"hide-accessible", HtmlUtil.escape(title)}, false) );
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\t");
          if (_jspx_meth_aui_script_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_clay_content$1col_5, _jspx_page_context))
            return;
          out.write("\n");
          out.write("\t\t\t\t\t\t");
          out.write("\n");
          ...
          _jspx_th_liferay$1ui_icon_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_5);
          _jspx_th_liferay$1ui_icon_2.setIcon("print");
          _jspx_th_liferay$1ui_icon_2.setLinkCssClass("btn btn-monospaced btn-outline-borderless btn-outline-secondary btn-sm");
          _jspx_th_liferay$1ui_icon_2.setMarkupView("lexicon");
          _jspx_th_liferay$1ui_icon_2.setMessage( LanguageUtil.format(request, "print-x-x", new Object[] {"hide-accessible", HtmlUtil.escape(title)}, false) );
          _jspx_th_liferay$1ui_icon_2.setUrl( "javascript:" + liferayPortletResponse.getNamespace() + "printPage_" + id + "();" );
          ...
          _jspx_th_aui_script_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_5);
        ...
        out.write("\t\t\t");
if (
 Validator.isNotNull(assetPublisherDisplayContext.getSocialBookmarksTypes()) ) {
        out.write("\n");
        out.write("\t\t\t\t");
        //  clay:content-col
        ...
        if (_jspx_eval_clay_content$1col_6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1social$1bookmarks_bookmarks_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_6);
	...
	boolean showLocalization = assetPublisherDisplayContext.isShowAvailableLocales() && assetRenderer.isLocalizable() && !print;
      ...
      out.write("\t");
if (
 showConversions || showLocalization ) {
      out.write("\n");
      out.write("\t\t<hr class=\"separator\" />\n");
      out.write("\n");
      out.write("\t\t");
...
if (
 availableLanguageIds.length > 1 ) {
        out.write("\n");
        out.write("\t\t\t\t\t<div class=\"autofit-col locale-actions mr-3\">\n");
        out.write("\t\t\t\t\t\t");
        //  liferay-ui:language
        ...
        _jspx_th_liferay$1ui_language_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1row_2);
...
if (
 showConversions ) {
        ...
        _jspx_th_clay_content$1col_7.setCssClass("component-subtitle export-action");
...
if (
 assetPublisherDisplayContext.isEnableComments() && assetRenderer.isCommentable() ) {
  ...
  private boolean _jspx_meth_aui_script_0(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_content$1col_5, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:script
    ...
    _jspx_th_aui_script_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_5);
