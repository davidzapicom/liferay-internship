...
public final class view_005fasset_005fentries_005ftable_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (
 Validator.isNotNull(assetEntryResult.getTitle()) ) {
        ...
        if (_jspx_eval_clay_sheet$1header_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n");
          out.write("\t\t\t<p class=\"h4 sheet-title\">\n");
          out.write("\t\t\t\t");
        ...
        if (_jspx_eval_clay_sheet$1section_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\t\t\t<table class=\"table table-autofit\">\n");
          out.write("\t\t\t\t<thead>\n");
          out.write("\t\t\t\t\t<tr>\n");
          out.write("\t\t\t\t\t\t<th class=\"table-cell-expand table-title\">\n");
          out.write("\t\t\t\t\t\t\t");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t<th class=\"table-cell-expand\">\n");
          out.write("\t\t\t\t\t\t\t\t");
          //  liferay-ui:message
...
if (
 !stageableGroup.hasStagingGroup() ) {
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t<tr class=\"");
          out.print( ((previewClassNameId == assetEntry.getClassNameId()) && (previewClassPK == assetEntry.getClassPK())) ? "table-active" : StringPool.BLANK );
          out.write('"');
          out.write(' ');
          out.print( AUIUtil.buildData(fragmentsEditorData) );
          out.write(">\n");
          out.write("\t\t\t\t\t\t\t<td class=\"table-cell-expand table-title\">\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t");
if (
 Validator.isNotNull(viewURL) ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<a class=\"text-truncate-inline\" href=\"");
          out.print( viewURL );
          out.write("\">\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t");
if (
 Objects.equals(metadataField, "author") ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"table-cell-expand\">\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t");
          out.print( HtmlUtil.escape(PortalUtil.getUserName(assetRenderer.getUserId(), assetRenderer.getUserName())) );
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t");
          out.write("\n");
 ...
 Objects.equals(metadataField, "categories") ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"table-cell-expand\">\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t");
          ...
          _jspx_th_liferay$1asset_asset$1categories$1summary_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_sheet$1section_0);
 ...
 Objects.equals(metadataField, "tags") ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"table-cell-expand\">\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t");
          ...
          _jspx_th_liferay$1asset_asset$1tags$1summary_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_sheet$1section_0);
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"table-cell-expand-smallest\">\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t");
          //  liferay-ui:message
...
if (
 !stageableGroup.hasStagingGroup() ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t<td>\n");
          out.write("\t\t\t\t\t\t\t\t\t<span class=\"table-action-link\">\n");
          out.write("\t\t\t\t\t\t\t\t\t\t");
