...
Format dateFormatDate = FastDateFormatFactoryUtil.getDate(locale, timeZone);
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setChecked( assetPublisherDisplayContext.isSelectionStyleAssetList() );
        _jspx_th_aui_input_0.setId("selectionStyleAssetList");
        _jspx_th_aui_input_0.setLabel("collection");
        _jspx_th_aui_input_0.setName("preferences--selectionStyle--");
        _jspx_th_aui_input_0.setOnChange( liferayPortletResponse.getNamespace() + "chooseSelectionStyle();" );
        _jspx_th_aui_input_0.setType("radio");
        _jspx_th_aui_input_0.setValue( AssetPublisherSelectionStyleConstants.TYPE_ASSET_LIST );
        ...
        _jspx_th_aui_input_1.setOnChange( liferayPortletResponse.getNamespace() + "chooseSelectionStyle();" );
        _jspx_th_aui_input_1.setType("radio");
        _jspx_th_aui_input_1.setValue( AssetPublisherSelectionStyleConstants.TYPE_DYNAMIC );
        ...
        _jspx_th_aui_input_2.setOnChange( liferayPortletResponse.getNamespace() + "chooseSelectionStyle();" );
        _jspx_th_aui_input_2.setType("radio");
        _jspx_th_aui_input_2.setValue( AssetPublisherSelectionStyleConstants.TYPE_MANUAL );
