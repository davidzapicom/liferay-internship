...
public final class view_005fasset_005fentry_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (AssetEntryResult assetEntryResult : assetPublisherDisplayContext.getAssetEntryResults()) {
	List<AssetEntry> assetEntries = assetEntryResult.getAssetEntries();
      ...
      out.write("\t\t");
if (
 Objects.equals(assetPublisherDisplayContext.getDisplayStyle(), "abstracts") ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t");
      ...
      _jspx_th_liferay$1util_include_0.setPage("/view_asset_entries_abstract.jsp");
 ...
 Objects.equals(assetPublisherDisplayContext.getDisplayStyle(), "full-content") ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t");
      ...
      _jspx_th_liferay$1util_include_1.setPage("/view_asset_entries_full_content.jsp");
 ...
 Objects.equals(assetPublisherDisplayContext.getDisplayStyle(), "table") ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t");
      ...
      _jspx_th_liferay$1util_include_2.setPage("/view_asset_entries_table.jsp");
 ...
 Objects.equals(assetPublisherDisplayContext.getDisplayStyle(), "title-list") ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t");
      ...
      _jspx_th_liferay$1util_include_3.setPage("/view_asset_entries_title_list.jsp");
 ...
 StringUtil.startsWith(assetPublisherDisplayContext.getDisplayStyle(), PortletDisplayTemplateManager.DISPLAY_STYLE_PREFIX) ) {
      out.write("\n");
      out.write("\t\t\t");
if (
 Validator.isNotNull(assetEntryResult.getTitle()) ) {
      ...
      _jspx_th_liferay$1util_include_4.setPage( "/display/" + TextFormatter.format(assetPublisherDisplayContext.getDisplayStyle(), TextFormatter.N) + ".jsp" );
