...
List<Group> selectedGroups = GroupLocalServiceUtil.getGroups(assetPublisherDisplayContext.getGroupIds());
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                if (_jspx_eval_liferay$1portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_portlet_param_1.setValue( configurationRenderURL.toString() );
                  ...
                  _jspx_th_portlet_param_2.setValue( assetPublisherHelper.getScopeId(group, scopeGroupId) );
	...
	for (Group group : availableGroups) {
		if (ArrayUtil.contains(assetPublisherDisplayContext.getGroupIds(), group.getGroupId())) {
          ...
          out.write("\t\t");
          //  liferay-portlet:actionURL
          com.liferay.taglib.portlet.ActionURLTag _jspx_th_liferay$1portlet_actionURL_1 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.taglib.portlet.ActionURLTag.class) : new com.liferay.taglib.portlet.ActionURLTag();
          ...
          if (_jspx_eval_liferay$1portlet_actionURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_4.setValue( configurationRenderURL.toString() );
          ...
          if (_jspx_th_liferay$1portlet_actionURL_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1portlet_actionURL_1);
            _jspx_th_liferay$1portlet_actionURL_1.release();
            return;
          }
          if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1portlet_actionURL_1);
          _jspx_th_liferay$1portlet_actionURL_1.release();
...
PortletURL itemSelectorURL = PortletURLBuilder.create(
	...
	"plid", layout.getPlid()
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tconst form = document.");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("fm;\n");
          out.write("\n");
          out.write("\tconst scopeSelect = document.getElementById(\n");
          out.write("\t\t'");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tif (scopeSelect) {\n");
          out.write("\t\tscopeSelect.addEventListener('click', (event) => {\n");
          out.write("\t\t\tevent.preventDefault();\n");
          out.write("\n");
          out.write("\t\t\tconst opener = Liferay.Util.getOpener();\n");
          out.write("\n");
          out.write("\t\t\topener.Liferay.Util.openSelectionModal({\n");
          out.write("\t\t\t\tid: '");
          out.print( eventName );
          out.write("' + event.currentTarget.id,\n");
          out.write("\t\t\t\tonSelect: function (event) {\n");
          out.write("\t\t\t\t\tLiferay.Util.postForm(form, {\n");
          out.write("\t\t\t\t\t\tdata: {\n");
          out.write("\t\t\t\t\t\t\tcmd: 'add-scope',\n");
