...
List<AssetRendererFactory<?>> classTypesAssetRendererFactories = new ArrayList<>();
	...
	request.setAttribute("configuration.jsp-redirect", redirect);
        ...
        _jspx_th_liferay$1ui_success_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_edit$1form_0);
        _jspx_th_liferay$1ui_success_0.setKey( portletResource + "requestProcessed" );
        _jspx_th_liferay$1ui_success_0.setMessage("the-collection-was-created-successfully");
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1footer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_button_0.setOnClick( liferayPortletResponse.getNamespace() + "saveSelectBoxes();" );
      ...
      out.write("\t\t);\n");
      out.write("\t\tvar currentMetadataFieldsInput = Liferay.Util.getFormElement(\n");
      out.write("\t\t\tform,\n");
      out.write("\t\t\t'currentMetadataFields'\n");
      out.write("\t\t);\n");
      out.write("\n");
      out.write("\t\tif (currentClassNameIdsSelect && currentMetadataFieldsInput) {\n");
      ...
      out.write("\t\t\t\t\t),\n");
      out.write("\t\t\t\t\tmetadataFields: Liferay.Util.getSelectedOptionValues(\n");
      out.write("\t\t\t\t\t\tcurrentMetadataFieldsInput\n");
      out.write("\t\t\t\t\t),\n");
      out.write("\t\t\t\t},\n");
      out.write("\t\t\t});\n");
      out.write("\t\t}\n");
      out.write("\t\telse if (currentMetadataFieldsInput) {\n");
      out.write("\t\t\tLiferay.Util.postForm(form, {\n");
      out.write("\t\t\t\tdata: {\n");
      out.write("\t\t\t\t\tmetadataFields: Liferay.Util.getSelectedOptionValues(\n");
      out.write("\t\t\t\t\t\tcurrentMetadataFieldsInput\n");
  ...
  private boolean _jspx_meth_aui_input_4(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_edit$1form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_input_4.setName("assetEntryIds");
