...
if (
 dropdownItems.size() > 1 ) {
      ...
      _jspx_th_liferay$1ui_icon$1menu_0.setTriggerCssClass("text-primary");
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_liferay$1ui_icon_0.setMessage( String.valueOf(dropdownItem.get("label")) );
          _jspx_th_liferay$1ui_icon_0.setMethod("get");
          _jspx_th_liferay$1ui_icon_0.setUrl( String.valueOf(dropdownItem.get("href")) );
          _jspx_th_liferay$1ui_icon_0.setUseDialog( GetterUtil.getBoolean(data.get("useDialog")) );
      ...
      _jspx_th_liferay$1ui_icon_1.setCssClass("visible-interaction");
      _jspx_th_liferay$1ui_icon_1.setData( (HashMap)dropdownItem.get("data") );
      _jspx_th_liferay$1ui_icon_1.setIcon( String.valueOf(dropdownItem.get("icon")) );
      _jspx_th_liferay$1ui_icon_1.setLinkCssClass("text-primary");
      _jspx_th_liferay$1ui_icon_1.setMarkupView("lexicon");
      _jspx_th_liferay$1ui_icon_1.setMessage( String.valueOf(dropdownItem.get("label")) );
      _jspx_th_liferay$1ui_icon_1.setMethod("get");
      _jspx_th_liferay$1ui_icon_1.setUrl( String.valueOf(dropdownItem.get("href")) );
      _jspx_th_liferay$1ui_icon_1.setUseDialog( GetterUtil.getBoolean(data.get("useDialog")) );
