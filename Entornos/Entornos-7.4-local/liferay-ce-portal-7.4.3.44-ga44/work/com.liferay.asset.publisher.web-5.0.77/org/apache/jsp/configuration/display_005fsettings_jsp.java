...
PortletURL configurationRenderURL = (PortletURL)request.getAttribute("configuration.jsp-configurationRenderURL");
      ...
      _jspx_th_liferay$1template_template$1selector_0.setParent(null);
      _jspx_th_liferay$1template_template$1selector_0.setClassName( AssetEntry.class.getName() );
      _jspx_th_liferay$1template_template$1selector_0.setDefaultDisplayStyle( assetPublisherDisplayContext.getDefaultDisplayStyle() );
      _jspx_th_liferay$1template_template$1selector_0.setDisplayStyle( assetPublisherDisplayContext.getDisplayStyle() );
      _jspx_th_liferay$1template_template$1selector_0.setDisplayStyleGroupId( assetPublisherDisplayContext.getDisplayStyleGroupId() );
      _jspx_th_liferay$1template_template$1selector_0.setDisplayStyles( Arrays.asList(assetPublisherDisplayContext.getDisplayStyles()) );
      _jspx_th_liferay$1template_template$1selector_0.setDynamicAttribute(null, "label", new String("display-template"));
      _jspx_th_liferay$1template_template$1selector_0.setRefreshURL( configurationRenderURL.toString() );
      ...
      _jspx_th_aui_input_3.setHelpMessage( LanguageUtil.format(request, "number-of-items-to-display-help", new Object[] {SearchContainer.MAX_DELTA}, false) );
	...
	for (String paginationType : assetPublisherDisplayContext.PAGINATION_TYPES) {
      ...
      out.write('\n');
if (
 !assetPublisherDisplayContext.isSearchWithIndex() && assetPublisherDisplayContext.isSelectionStyleDynamic() ) {
      out.write('\n');
      out.write('	');
      //  aui:input
  ...
  private boolean _jspx_meth_liferay$1frontend_component_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1frontend_component_0.setModule("js/DisplaySettings");
