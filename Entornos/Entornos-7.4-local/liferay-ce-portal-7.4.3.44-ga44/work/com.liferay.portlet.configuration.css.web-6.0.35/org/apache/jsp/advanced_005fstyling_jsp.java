...
PortletConfigurationCSSPortletDisplayContext portletConfigurationCSSPortletDisplayContext = new PortletConfigurationCSSPortletDisplayContext(renderRequest);
      ...
      out.print( HtmlUtil.escapeJS(portletConfigurationCSSPortletDisplayContext.getPortletResource()) );
      out.write("</strong>\n");
      out.write("\t</p>\n");
      out.write("\n");
      out.write("\t<p>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div id=\"lfr-add-rule-container\">\n");
      out.write("\t");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\tvar customCSSTextarea = document.getElementById(\n");
          out.write("\t\t\t'");
          ...
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tif (customCSSTextarea) {\n");
          out.write("\t\t\tvar customCSSTextareaValue = customCSSTextarea.value.trim();\n");
          out.write("\n");
          out.write("\t\t\tif (customCSSTextareaValue.length) {\n");
          out.write("\t\t\t\tcustomCSSTextareaValue += '\\n\\n';\n");
          out.write("\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\tvar newValue = customCSSTextareaValue + value + ' {\\n\\t\\n}\\n';\n");
          out.write("\n");
          out.write("\t\t\tcustomCSSTextarea.value = newValue;\n");
          out.write("\n");
          out.write("\t\t\tcustomCSSTextarea.focus();\n");
          out.write("\n");
          out.write("\t\t\tvar newCursorPosition = customCSSTextarea.value.length - 3;\n");
          out.write("\n");
          out.write("\t\t\tcustomCSSTextarea.setSelectionRange(\n");
          out.write("\t\t\t\tnewCursorPosition,\n");
          out.write("\t\t\t\tnewCursorPosition\n");
          out.write("\t\t\t);\n");
          out.write("\t\t}\n");
          out.write("\t}\n");
          ...
          if (_jspx_meth_portlet_namespace_11((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("addClass.addEventListener('click', () => {\n");
          out.write("\t\t\t");
          ...
          out.write("\t}\n");
          out.write("\n");
          out.write("\tvar portlet = Liferay.Util.getOpener()[\n");
          out.write("\t\t'portlet_");
          out.print( HtmlUtil.escapeJS(portletConfigurationCSSPortletDisplayContext.getPortletResource()) );
          out.write("'\n");
          out.write("\t];\n");
          ...
          out.write("\t\tvar portletContent = portlet.querySelector('.portlet-content');\n");
          out.write("\n");
          out.write("\t\tif (portletContent) {\n");
          out.write("\t\t\tvar portletClasses;\n");
          out.write("\n");
          out.write("\t\t\tif (portlet != portletContent) {\n");
          out.write("\t\t\t\tportletClasses = portlet\n");
          out.write("\t\t\t\t\t.getAttribute('class')\n");
          out.write("\t\t\t\t\t.replace(/(?:^|\\s)portlet(?=\\s|$)/g, '');\n");
          out.write("\n");
          out.write("\t\t\t\tportletClasses = portletClasses.replace(/\\s+/g, '.').trim();\n");
          out.write("\n");
          out.write("\t\t\t\tif (portletClasses) {\n");
          out.write("\t\t\t\t\tportletClasses = ' .' + portletClasses;\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\tvar boundaryClasses = [];\n");
          out.write("\n");
          out.write("\t\t\tportletContent\n");
          out.write("\t\t\t\t.getAttribute('class')\n");
          out.write("\t\t\t\t.replace(\n");
          out.write("\t\t\t\t\t/(?:([\\w\\d-]+)-)?portlet(?:-?([\\w\\d-]+-?))?/g,\n");
          out.write("\t\t\t\t\t(match, subMatch1, subMatch2) => {\n");
          out.write("\t\t\t\t\t\tvar regexIgnoredClasses = /boundary|draggable/;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (!regexIgnoredClasses.test(subMatch2)) {\n");
          out.write("\t\t\t\t\t\t\tboundaryClasses.push(match);\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tportletClasses = '.' + boundaryClasses.join('.') + portletClasses;\n");
          out.write("\n");
          out.write("\t\t\tvar portletClassesNode = document.getElementById(\n");
          out.write("\t\t\t\t'");
          ...
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tif (portletClassesNode) {\n");
          out.write("\t\t\t\tportletClassesNode.innerHTML = portletClasses;\n");
          out.write("\t\t\t}\n");
          out.write("\t\t}\n");
          out.write("\t}\n");
