...
PortletConfigurationCSSPortletDisplayContext portletConfigurationCSSPortletDisplayContext = new PortletConfigurationCSSPortletDisplayContext(renderRequest);
      ...
      out.write('	');
if (
 portletConfigurationCSSPortletDisplayContext.hasAccess() ) {
      out.write("\n");
      out.write("\t\t");
      //  portlet:actionURL
      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_1.setName("portletId");
        _jspx_th_aui_input_1.setType("hidden");
        _jspx_th_aui_input_1.setValue( HtmlUtil.escapeJS(portletConfigurationCSSPortletDisplayContext.getPortletResource()) );
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t(event) => {\n");
        out.write("\t\t\t\t\tvar toggle = event.delegateTarget;\n");
        out.write("\n");
        out.write("\t\t\t\t\tvar disableOnChecked =\n");
        out.write("\t\t\t\t\t\ttoggle.dataset.disableonchecked === undefined ||\n");
        out.write("\t\t\t\t\t\ttoggle.dataset.disableonchecked === 'true';\n");
        out.write("\t\t\t\t\tvar inputs = document.querySelectorAll(toggle.dataset.inputselector);\n");
        out.write("\n");
        out.write("\t\t\t\t\tfor (var i = 0; i < inputs.length; i++) {\n");
        out.write("\t\t\t\t\t\tvar input = inputs[i];\n");
        out.write("\n");
        out.write("\t\t\t\t\t\tinput.disabled = disableOnChecked\n");
        out.write("\t\t\t\t\t\t\t? toggle.checked\n");
        out.write("\t\t\t\t\t\t\t: !toggle.checked;\n");
        out.write("\n");
        out.write("\t\t\t\t\t\tif (!input.disabled) {\n");
        out.write("\t\t\t\t\t\t\tinput.classList.remove('disabled');\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t\tif (input.labels.length > 0) {\n");
        out.write("\t\t\t\t\t\t\t\tinput.labels[0].classList.remove('disabled');\n");
        out.write("\t\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\telse {\n");
        out.write("\t\t\t\t\t\t\tif (input.labels.length > 0) {\n");
        out.write("\t\t\t\t\t\t\t\tinput.labels[0].classList.add('disabled');\n");
        out.write("\t\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t}\n");
        out.write("\t\t\t\t}\n");
