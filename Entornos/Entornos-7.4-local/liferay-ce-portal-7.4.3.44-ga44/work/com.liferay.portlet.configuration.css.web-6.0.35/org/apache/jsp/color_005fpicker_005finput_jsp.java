...
public final class color_005fpicker_005finput_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String name = ParamUtil.getString(request, "name");
      ...
      out.write("\" />\n");
      out.write("\n");
      out.write("\t\t<div class=\"clay-color-picker\">\n");
      out.write("\t\t\t<label>");
      out.print( label );
      out.write("</label>\n");
      out.write("\n");
      out.write("\t\t\t<div class=\"clay-color input-group\">\n");
      out.write("\t\t\t\t<div class=\"input-group-item input-group-item-shrink input-group-prepend\">\n");
      out.write("\t\t\t\t\t<div class=\"input-group-text\">\n");
      out.write("\t\t\t\t\t\t<button class=\"btn clay-color-btn dropdown-toggle\" style=\"border-width: 0px; height: 28px; width: 28px;\" title=\"");
      out.print( color );
      out.write("\" type=\"button\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"input-group-append input-group-item\">\n");
      out.write("\t\t\t\t\t<input class=\"form-control input-group-inset input-group-inset-before\" type=\"text\" />\n");
      out.write("\n");
      out.write("\t\t\t\t\t<label class=\"input-group-inset-item input-group-inset-item-before\">");
      out.print( color );
      out.write("</label>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      ...
      _jspx_th_react_component_0.setModule("js/ColorPickerInput.es");
