...
String portletNamespace = PortalUtil.getPortletNamespace(ProductNavigationControlMenuPortletKeys.PRODUCT_NAVIGATION_CONTROL_MENU);
      ...
      out.write("\"\n");
      out.write("\t\tclass=\"control-menu-icon lfr-portal-tooltip product-menu-toggle sidenav-toggler\"\n");
      out.write("\t\tdata-content=\"body\"\n");
      out.write("\t\tdata-open-class=\"open-admin-panel\"\n");
      out.write("\t\tdata-qa-id=\"add\"\n");
      ...
      out.print( LanguageUtil.get(request, "add") );
      out.write("\"\n");
      out.write("\t\tdata-toggle=\"liferay-sidenav\"\n");
      out.write("\t\tdata-type=\"fixed-push\"\n");
      out.write("\t\tdata-type-mobile=\"fixed\"\n");
      out.write("\t\tdata-url=\"");
      out.print(
...
if (Validator.isNotNull(className) && (classPK > 0)) {
	...
	assetRenderer = assetRendererFactory.getAssetRenderer(classPK);
      ...
      out.write('\n');
if (
 (assetRenderer != null) && PortletPermissionUtil.contains(permissionChecker, layout, portletId, ActionKeys.ADD_TO_PAGE) ) {
      out.write('\n');
      out.write('	');
      //  aui:script
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\tLiferay.once('updatedLayout', () => {\n");
          out.write("\t\t\tLiferay.Util.navigate(\n");
          out.write("\t\t\t\t'");
          out.print( PortalUtil.getLayoutFullURL(layout, themeDisplay) );
          out.write("'\n");
          out.write("\t\t\t);\n");
          out.write("\t\t});\n");
          out.write("\t");
