...
if (
 !applicationsMenuInstanceConfiguration.enableApplicationsMenu() ) {
      ...
      out.write("\t\t\t");
if (
 !productMenuDisplayContext.isShowLayoutsTree() || (Objects.equals(productMenuState, "open") && !Objects.equals(pagesTreeState, "open")) ) {
      out.write("\n");
      out.write("\t\t\t\t");
 ...
 Objects.equals(productMenuState, "open") && Objects.equals(pagesTreeState, "open") ) {
  ...
  private boolean _jspx_meth_clay_content$1col_1(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_content$1row_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_clay_content$1col_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      out.write("\n");
      out.write("\t\t\t\t\t");
      if (_jspx_meth_aui_icon_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_clay_content$1col_1, _jspx_page_context))
        return true;
      out.write("\n");
      out.write("\t\t\t\t");
    }
  ...
  private boolean _jspx_meth_aui_icon_0(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_content$1col_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:icon
    ...
    _jspx_th_aui_icon_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_content$1col_1);
    ...
    _jspx_th_aui_icon_0.setUrl("javascript:void(0);");
