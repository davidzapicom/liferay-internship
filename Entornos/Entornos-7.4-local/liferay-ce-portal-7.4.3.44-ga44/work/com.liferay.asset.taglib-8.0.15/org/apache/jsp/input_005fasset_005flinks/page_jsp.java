...
StagingGroupHelper stagingGroupHelper = StagingGroupHelperUtil.getStagingGroupHelper();
	...
	for (Map<String, Object> selectorEntry : inputAssetLinksDisplayContext.getSelectorEntries()) {
          ...
          _jspx_th_liferay$1ui_icon_0.setData( (Map<String, Object>)selectorEntry.get("data") );
          _jspx_th_liferay$1ui_icon_0.setId( (String)selectorEntry.get("id") );
          _jspx_th_liferay$1ui_icon_0.setMessage( HtmlUtil.escape((String)selectorEntry.get("message")) );
      ...
      if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		...
		AssetEntry assetLinkEntry = inputAssetLinksDisplayContext.getAssetLinkEntry(assetLink);
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                out.write("\n");
                out.write("\t\t\t<h4 class=\"list-group-title\">\n");
                out.write("\t\t\t\t");
                out.print( HtmlUtil.escape(assetLinkEntry.getTitle(locale)) );
                out.write("\n");
                out.write("\t\t\t</h4>\n");
                out.write("\n");
                out.write("\t\t\t<p class=\"list-group-subtitle\">\n");
                out.write("\t\t\t\t");
...
if (
 stagingGroupHelper.isLiveGroup(themeDisplay.getScopeGroupId()) ) {
      ...
      _jspx_th_aui_script_0.setUse("aui-base,liferay-search-container");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\tonSelect: function (assetEntryIds) {\n");
          out.write("\t\t\t\t\tif (assetEntryIds) {\n");
          out.write("\t\t\t\t\t\tArray.prototype.forEach.call(\n");
          out.write("\t\t\t\t\t\t\tassetEntryIds,\n");
          out.write("\t\t\t\t\t\t\t(assetEntry) => {\n");
          out.write("\t\t\t\t\t\t\t\tvar entityId = assetEntry.entityid;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tif (searchContainerData.indexOf(entityId) == -1) {\n");
          out.write("\t\t\t\t\t\t\t\t\tvar entryLink =\n");
          out.write("\t\t\t\t\t\t\t\t\t\t'<div class=\"text-right\"><a class=\"modify-link\" data-rowId=\"' +\n");
          out.write("\t\t\t\t\t\t\t\t\t\tentityId +\n");
          out.write("\t\t\t\t\t\t\t\t\t\t'\" href=\"javascript:void(0);\">");
          out.print( UnicodeFormatter.toString(removeLinkIcon) );
          out.write("</a></div>';\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\tvar entryHtml =\n");
          out.write("\t\t\t\t\t\t\t\t\t\t'<h4 class=\"list-group-title\">' +\n");
          out.write("\t\t\t\t\t\t\t\t\t\tLiferay.Util.escapeHTML(\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tassetEntry.assettitle\n");
          out.write("\t\t\t\t\t\t\t\t\t\t) +\n");
          out.write("\t\t\t\t\t\t\t\t\t\t'</h4><p class=\"list-group-subtitle\">' +\n");
          out.write("\t\t\t\t\t\t\t\t\t\tLiferay.Util.escapeHTML(\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tassetEntry.assettype\n");
          out.write("\t\t\t\t\t\t\t\t\t\t) +\n");
          out.write("\t\t\t\t\t\t\t\t\t\t'</p><p class=\"list-group-subtitle\">");
          if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write(": ' +\n");
          out.write("\t\t\t\t\t\t\t\t\t\tLiferay.Util.escapeHTML(\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tassetEntry.groupdescriptivename\n");
          out.write("\t\t\t\t\t\t\t\t\t\t) +\n");
          out.write("\t\t\t\t\t\t\t\t\t\t'</p>';\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\tsearchContainer.addRow(\n");
          out.write("\t\t\t\t\t\t\t\t\t\t[entryHtml, entryLink],\n");
          out.write("\t\t\t\t\t\t\t\t\t\tentityId\n");
          out.write("\t\t\t\t\t\t\t\t\t);\n");
          out.write("\n");
          ...
          out.write("\t\t\t\turl: event.currentTarget.attr('data-href'),\n");
          out.write("\t\t\t});\n");
          out.write("\t\t},\n");
  ...
  private boolean _jspx_meth_liferay$1ui_icon_1(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1util_buffer_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_icon_1.setIcon("times-circle");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("related-assets-for-staged-asset-types-can-be-managed-on-the-staging-site");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("scope");
