...
List<Map<String, String>> selectedItems = (List<Map<String, String>>)data.get("selectedItems");
      ...
      out.write("\n");
      out.write("<div>\n");
      out.write("\t<div class=\"lfr-tags-selector-content\">\n");
      out.write("\n");
      out.write("\t\t");
      ...
      out.print( selectedItem.get("value") );
      out.write("\" />\n");
      out.write("\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t<label for=\"namespace_assetTagsSelector_MultiSelect\">\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t</label>\n");
      out.write("\n");
      out.write("\t\t\t<div class=\"input-group input-group-stacked-sm-down\">\n");
      out.write("\t\t\t\t<div class=\"input-group-item\">\n");
      out.write("\t\t\t\t\t<div class=\"form-control form-control-tag-group\">\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t");
      ...
      _jspx_th_clay_label_0.setLabel( HtmlUtil.escape(selectedItem.get("label")) );
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control-inset\" id=\"namespace_assetTagsSelector_MultiSelect\" type=\"text\" value=\"\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      ...
      _jspx_th_react_component_0.setModule("asset_tags_selector/AssetTagsSelectorTag.es");
