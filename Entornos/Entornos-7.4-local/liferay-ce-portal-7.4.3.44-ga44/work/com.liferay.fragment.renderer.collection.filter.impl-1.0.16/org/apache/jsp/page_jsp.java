...
if (
 fragmentCollectionFilter != null ) {
      ...
      _jspx_th_liferay$1frontend_component_0.setModule("js/CollectionFilterRegister");
      ...
      _jspx_th_clay_button_0.setCssClass("bg-light dropdown-toggle font-weight-bold form-control-select form-control-sm text-left w-100");
      _jspx_th_clay_button_0.setDisplayType("secondary");
      _jspx_th_clay_button_0.setLabel( StringPool.DASH );
