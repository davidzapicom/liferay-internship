...
AssetCategoriesNavigationPortletInstanceConfiguration assetCategoriesNavigationPortletInstanceConfiguration = assetCategoriesNavigationDisplayContext.getAssetCategoriesNavigationPortletInstanceConfiguration();
      ...
      _jspx_th_liferay$1frontend_edit$1form_0.setOnSubmit( "event.preventDefault(); " + liferayPortletResponse.getNamespace() + "saveConfiguration();" );
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_liferay$1frontend_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_liferay$1template_template$1selector_0.setClassName( AssetCategory.class.getName() );
              _jspx_th_liferay$1template_template$1selector_0.setDisplayStyle( assetCategoriesNavigationPortletInstanceConfiguration.displayStyle() );
              _jspx_th_liferay$1template_template$1selector_0.setDisplayStyleGroupId( assetCategoriesNavigationDisplayContext.getDisplayStyleGroupId() );
              _jspx_th_liferay$1template_template$1selector_0.setRefreshURL( configurationRenderURL );
              _jspx_th_liferay$1template_template$1selector_0.setShowEmptyOption( true );
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\tdata: {\n");
        out.write("\t\t\t\tassetVocabularyIds: Liferay.Util.getSelectedOptionValues(\n");
        out.write("\t\t\t\t\tLiferay.Util.getFormElement(form, 'currentAssetVocabularyIds')\n");
        out.write("\t\t\t\t),\n");
        out.write("\t\t\t},\n");
        out.write("\t\t});\n");
        out.write("\t}\n");
        ...
        if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("allAssetVocabularies',\n");
        out.write("\t\t'false',\n");
        out.write("\t\t'");
