...
rightList = ListUtil.sort(rightList, new KeyValuePairComparator(false, true));
      ...
      _jspx_th_aui_input_0.setValue( StringUtil.merge(types) );
	...
	for (String curDisplayStyle : displayStyles) {
      ...
      out.write("\n");
      out.write("\t\tvar socialBookmarksTypes = document.getElementById(\n");
      out.write("\t\t\t'");
      if (_jspx_meth_portlet_namespace_2(_jspx_page_context))
        return;
      out.write("socialBookmarksTypes'\n");
      out.write("\t\t);\n");
      out.write("\t\tvar currentTypes = document.getElementById(\n");
      out.write("\t\t\t'");
      ...
      out.write("\t\t);\n");
      out.write("\n");
      out.write("\t\tLiferay.after('inputmoveboxes:moveItem', (event) => {\n");
      out.write("\t\t\tsocialBookmarksTypes.value = Util.getSelectedOptionValues(currentTypes);\n");
      out.write("\t\t});\n");
      out.write("\n");
      out.write("\t\tLiferay.after('inputmoveboxes:orderItem', (event) => {\n");
      out.write("\t\t\tsocialBookmarksTypes.value = Util.getSelectedOptionValues(currentTypes);\n");
      out.write("\t\t});\n");
      out.write("\t})();\n");
      out.write("</script>");
