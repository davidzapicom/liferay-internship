...
public final class import_005fdata_005fdefinition_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Format dateFormatDateTime = FastDateFormatFactoryUtil.getDateTime(locale, timeZone);
      ...
      _jspx_th_liferay$1ui_icon_0.setIconCssClass("dropdown-item-indicator-start");
      _jspx_th_liferay$1ui_icon_0.setId("importDataDefinitionIcon");
      _jspx_th_liferay$1ui_icon_0.setMarkupView("lexicon");
      _jspx_th_liferay$1ui_icon_0.setMessage("import-structure");
      _jspx_th_liferay$1ui_icon_0.setOnClick( liferayPortletResponse.getNamespace() + "openImportDataDefinitionModal();" );
      ...
      _jspx_th_react_component_0.setModule("js/modals/ImportDataDefinitionModal");
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("openImportDataDefinitionModal() {\n");
        out.write("\t\tLiferay.componentReady(\n");
        out.write("\t\t\t'");
        if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("importDataDefinitionModal'\n");
        out.write("\t\t).then((importDataDefinitionModal) => {\n");
        out.write("\t\t\timportDataDefinitionModal.open();\n");
        out.write("\t\t});\n");
        out.write("\t}\n");
