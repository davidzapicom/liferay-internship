...
public final class view_005fsource_005ficon_jsp extends org.apache.jasper.runtime.HttpJspBase
...
JournalArticle article = (JournalArticle)request.getAttribute(WebKeys.JOURNAL_ARTICLE);
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("\tvar viewResourcesButton = document.getElementById(\n");
      out.write("\t\t'");
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("viewResourcesButton'\n");
      out.write("\t);\n");
      out.write("\n");
      out.write("\tif (viewResourcesButton) {\n");
      out.write("\t\tviewResourcesButton.addEventListener('click', (event) => {\n");
      out.write("\t\t\tLiferay.Util.openModal({\n");
      out.write("\t\t\t\ttitle:\n");
      out.write("\t\t\t\t\t'");
      out.print( HtmlUtil.escapeJS(HtmlUtil.escape(article.getTitle(themeDisplay.getLocale()))) );
      out.write("',\n");
      out.write("\t\t\t\turl:\n");
      out.write("\t\t\t\t\t'");
      //  portlet:renderURL
      ...
      if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_portlet_param_4.setValue( String.valueOf(article.getStatus()) );
  ...
  private boolean _jspx_meth_liferay$1ui_icon_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_icon_0.setId("viewResourcesButton");
    _jspx_th_liferay$1ui_icon_0.setMessage("view-source");
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("/configuration/icon/view_source.jsp");
