...
if (
 articleDisplay.isSmallImage() ) {
	...
	String summary = articleDisplay.getDescription();
      ...
      out.write("\t\t");
if (
 Validator.isNull(summary) ) {
      out.write("\n");
      out.write("\t\t\t");
      out.print( StringUtil.shorten(HtmlUtil.stripHtml(articleDisplay.getContent()), abstractLength) );
      out.write("\n");
      out.write("\t\t");
      out.write("\n");
      out.write("\t\t");
