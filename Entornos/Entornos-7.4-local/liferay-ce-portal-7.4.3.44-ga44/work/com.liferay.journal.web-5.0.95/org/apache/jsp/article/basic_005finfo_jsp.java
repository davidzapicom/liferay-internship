...
public final class basic_005finfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
DDMStructure ddmStructure = journalEditArticleDisplayContext.getDDMStructure();
      ...
      _jspx_th_aui_input_0.setName("ddmStructureKey");
      _jspx_th_aui_input_0.setType("hidden");
      _jspx_th_aui_input_0.setValue( ddmStructure.getStructureKey() );
...
if (
 journalWebConfiguration.changeableDefaultLanguage() ) {
      ...
      out.write("-change-default-language\">\n");
      out.write("\t\t");
      //  react:component
      ...
      _jspx_th_react_component_0.setModule("js/ChangeDefaultLanguage.es");
      _jspx_th_react_component_0.setProps( journalEditArticleDisplayContext.getChangeDefaultLanguageData() );
      ...
      out.write('\n');
if (
 journalEditArticleDisplayContext.isShowSelectFolder() ) {
      out.write("\n");
      out.write("\t<p class=\"article-folder\"><b>");
      if (_jspx_meth_liferay$1ui_message_0(_jspx_page_context))
        return;
      out.write("</b></p>\n");
      out.write("\n");
      out.write("\t<div class=\"form-group input-group mb-2\">\n");
      ...
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("folderName\" readonly=\"readonly\" title=\"");
      out.print( LanguageUtil.get(request, "folder-name") );
      out.write("\" type=\"text\" value=\"");
      out.print( journalEditArticleDisplayContext.getFolderName() );
      out.write("\" />\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("\n");
      ...
      _jspx_th_liferay$1frontend_component_0.setModule("js/SelectFolderButton");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<p class=\"article-structure\">\n");
      out.write("\t<b>");
      ...
      out.write("\n");
if (
 (article != null) && !article.isNew() && (journalEditArticleDisplayContext.getClassNameId() == JournalArticleConstants.CLASS_NAME_ID_DEFAULT) ) {
      out.write("\n");
      out.write("\t<p class=\"article-version-status\">\n");
      out.write("\t\t<b>");
      ...
      _jspx_th_clay_label_0.setCssClass("ml-2 text-uppercase");
      _jspx_th_clay_label_0.setDisplayType( WorkflowConstants.getStatusStyle(article.getStatus()) );
      _jspx_th_clay_label_0.setLabel( WorkflowConstants.getStatusLabel(article.getStatus()) );
      ...
      out.write('	');
if (
 !journalWebConfiguration.journalArticleForceAutogenerateId() && (journalEditArticleDisplayContext.getClassNameId() == JournalArticleConstants.CLASS_NAME_ID_DEFAULT) ) {
      out.write("\n");
      out.write("\t\t<div class=\"article-id\">\n");
      out.write("\t\t\t<label for=\"");
      if (_jspx_meth_portlet_namespace_1(_jspx_page_context))
        return;
      out.write("newArticleId\">");
      ...
      _jspx_th_aui_input_1.setValue( (article != null) ? article.getArticleId() : StringPool.BLANK );
      _jspx_th_aui_input_1.setWrapperCssClass("mb-1");
      ...
      _jspx_th_aui_input_2.setChecked( false );
      _jspx_th_aui_input_2.setLabel("autogenerate-id");
      _jspx_th_aui_input_2.setName("autoArticleId");
      _jspx_th_aui_input_2.setOnChange( taglibOnChange );
      _jspx_th_aui_input_2.setType("checkbox");
      _jspx_th_aui_input_2.setValue( false );
      _jspx_th_aui_input_2.setWrapperCssClass("mb-3");
...
if (
 (article != null) && !article.isNew() && (journalEditArticleDisplayContext.getClassNameId() == JournalArticleConstants.CLASS_NAME_ID_DEFAULT) ) {
      ...
      _jspx_th_liferay$1ui_input$1localized_0.setAvailableLocales( journalEditArticleDisplayContext.getAvailableLocales() );
      _jspx_th_liferay$1ui_input$1localized_0.setCssClass("form-control");
      _jspx_th_liferay$1ui_input$1localized_0.setDefaultLanguageId( journalEditArticleDisplayContext.getDefaultArticleLanguageId() );
      _jspx_th_liferay$1ui_input$1localized_0.setEditorName("ckeditor");
      _jspx_th_liferay$1ui_input$1localized_0.setFormName("fm");
      _jspx_th_liferay$1ui_input$1localized_0.setIgnoreRequestValue( journalEditArticleDisplayContext.isChangeStructure() );
      _jspx_th_liferay$1ui_input$1localized_0.setName("descriptionMapAsXML");
      _jspx_th_liferay$1ui_input$1localized_0.setSelectedLanguageId( journalEditArticleDisplayContext.getSelectedLanguageId() );
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("structure");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("version");
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\t\t\tvar autoArticleInput = document.getElementById(\n");
        out.write("\t\t\t\t'");
        if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("autoArticleId'\n");
        out.write("\t\t\t);\n");
        out.write("\t\t\tvar newArticleInput = document.getElementById(\n");
        out.write("\t\t\t\t'");
        ...
        out.write("\t\t\t);\n");
        out.write("\n");
        out.write("\t\t\tif (autoArticleInput && newArticleInput) {\n");
        out.write("\t\t\t\tnewArticleInput.disabled = autoArticleInput.checked;\n");
        out.write("\n");
        out.write("\t\t\t\tautoArticleInput.addEventListener('click', () => {\n");
        out.write("\t\t\t\t\tLiferay.Util.toggleDisabled(newArticleInput, !newArticleInput.disabled);\n");
        out.write("\t\t\t\t});\n");
        out.write("\t\t\t}\n");
        out.write("\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_4(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_4.setKey("id");
