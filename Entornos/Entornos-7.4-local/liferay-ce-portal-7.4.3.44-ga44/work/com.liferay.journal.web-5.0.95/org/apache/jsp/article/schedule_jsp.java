...
JournalEditArticleDisplayContext journalEditArticleDisplayContext = new JournalEditArticleDisplayContext(request, liferayPortletResponse, journalDisplayContext.getArticle());
      ...
      _jspx_th_aui_model$1context_0.setBean( journalDisplayContext.getArticle() );
      ...
      _jspx_th_aui_input_1.setDisabled( journalEditArticleDisplayContext.isNeverExpire() );
      _jspx_th_aui_input_1.setFormName("fm1");
      _jspx_th_aui_input_1.setName("expirationDate");
      _jspx_th_aui_input_1.setWrapperCssClass("expiration-date mb-3");
      ...
      _jspx_th_aui_input_2.setDisabled( journalEditArticleDisplayContext.isNeverReview() );
      _jspx_th_aui_input_2.setFormName("fm1");
      _jspx_th_aui_input_2.setName("reviewDate");
      _jspx_th_aui_input_2.setWrapperCssClass("mb-3 review-date");
