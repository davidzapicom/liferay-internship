...
public final class edit_005fdata_005fdefinition_jsp extends org.apache.jasper.runtime.HttpJspBase
...
editDDMStructureURL.setParameter("structureKey", String.valueOf(ddmStructureKey));
      ...
      if (_jspx_eval_liferay$1util_html$1top_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t<link href=\"");
          out.print( PortalUtil.getStaticResourceURL(request, PortalUtil.getPathModule() + "/journal-web/css/ddm_form.css") );
      ...
      _jspx_th_aui_form_0.setAction( editDDMStructureURL );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_4.setName("dataDefinitionId");
        _jspx_th_aui_input_4.setType("hidden");
        _jspx_th_aui_input_4.setValue( journalEditDDMStructuresDisplayContext.getDDMStructureId() );
        ...
        _jspx_th_aui_input_5.setName("languageId");
        _jspx_th_aui_input_5.setType("hidden");
        _jspx_th_aui_input_5.setValue( journalEditDDMStructuresDisplayContext.getDefaultLanguageId() );
        ...
        if (_jspx_eval_clay_container$1fluid_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_0);
          _jspx_th_aui_input_6.setActiveLanguageIds( journalEditDDMStructuresDisplayContext.getAvailableLanguageIds() );
          _jspx_th_aui_input_6.setAdminMode( true );
          _jspx_th_aui_input_6.setCssClass("form-control-inline");
          _jspx_th_aui_input_6.setDefaultLanguageId( (ddmForm == null) ? LocaleUtil.toLanguageId(LocaleUtil.getSiteDefault()): LocaleUtil.toLanguageId(ddmForm.getDefaultLocale()) );
          _jspx_th_aui_input_6.setLabel("");
          _jspx_th_aui_input_6.setLanguagesDropdownDirection("down");
          _jspx_th_aui_input_6.setLocalized( true );
          _jspx_th_aui_input_6.setName("name");
          _jspx_th_aui_input_6.setPlaceholder( LanguageUtil.format(request, "untitled-x", "structure") );
          _jspx_th_aui_input_6.setRequired( true );
          _jspx_th_aui_input_6.setType("text");
          _jspx_th_aui_input_6.setWrapperCssClass("article-content-title mb-0");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t");
          if (_jspx_meth_aui_button_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_clay_container$1fluid_0, _jspx_page_context))
            return;
          out.write("\n");
          out.write("\t\t\t\t\t</div>\n");
          out.write("\t\t\t\t</li>\n");
        ...
        if (_jspx_eval_clay_container$1fluid_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n");
          out.write("\t\t\t<div class=\"contextual-sidebar-mr\">\n");
          out.write("\t\t\t\t");
if (
...
if (
 (ddmStructure != null) && (groupId != scopeGroupId) ) {
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\t<div class=\"contextual-sidebar-mr-n\">\n");
          out.write("\t\t\t\t\t");
          //  liferay-data-engine:data-layout-builder
          com.liferay.data.engine.taglib.servlet.taglib.DataLayoutBuilderTag _jspx_th_liferay$1data$1engine_data$1layout$1builder_0 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.data.engine.taglib.servlet.taglib.DataLayoutBuilderTag.class) : new com.liferay.data.engine.taglib.servlet.taglib.DataLayoutBuilderTag();
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setPageContext(_jspx_page_context);
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_clay_container$1fluid_1);
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setAdditionalPanels( journalEditDDMStructuresDisplayContext.getAdditionalPanels(npmResolvedPackageName) );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setComponentId( liferayPortletResponse.getNamespace() + "dataLayoutBuilder" );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setContentType("journal");
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setDataDefinitionId( ddmStructureId );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setGroupId( groupId );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setNamespace( liferayPortletResponse.getNamespace() );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setScopes( SetUtil.fromCollection(Arrays.asList("journal")) );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setSearchableFieldsDisabled( !journalEditDDMStructuresDisplayContext.isStructureFieldIndexableEnable() );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setDynamicAttribute(null, "singlePage",  true );
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.setSubmitButtonId( liferayPortletResponse.getNamespace() + "submitButton" );
          int _jspx_eval_liferay$1data$1engine_data$1layout$1builder_0 = _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.doStartTag();
          if (_jspx_th_liferay$1data$1engine_data$1layout$1builder_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1data$1engine_data$1layout$1builder_0);
            _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.release();
            return;
          }
          if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1data$1engine_data$1layout$1builder_0);
          _jspx_th_liferay$1data$1engine_data$1layout$1builder_0.release();
      ...
      _jspx_th_liferay$1frontend_component_0.setComponentId( liferayPortletResponse.getNamespace() + "DataEngineLayoutBuilderHandler" );
      _jspx_th_liferay$1frontend_component_0.setContext( journalEditDDMStructuresDisplayContext.getDataEngineLayoutBuilderHandlerContext() );
      _jspx_th_liferay$1frontend_component_0.setModule("js/DataEngineLayoutBuilderHandler.es");
      ...
      _jspx_th_liferay$1frontend_component_1.setComponentId( liferayPortletResponse.getNamespace() + "LocaleChangedHandlerComponent" );
      _jspx_th_liferay$1frontend_component_1.setContext( journalEditDDMStructuresDisplayContext.getLocaleChangedHandlerContext() );
      _jspx_th_liferay$1frontend_component_1.setModule("js/LocaleChangedHandler.es");
  ...
  private boolean _jspx_meth_aui_input_2(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_input_2.setName("dataDefinition");
  ...
  private boolean _jspx_meth_aui_input_3(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_input_3.setName("dataLayout");
  ...
  private boolean _jspx_meth_aui_button_1(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_container$1fluid_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:button
    ...
    _jspx_th_aui_button_1.setId("submitButton");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_container$1fluid_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("there-are-content-references-to-this-structure.-you-may-lose-data-if-a-field-name-is-renamed-or-removed");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_container$1fluid_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("there-are-template-references-to-this-structure.-please-update-them-if-a-field-name-is-renamed-or-removed");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_container$1fluid_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("this-structure-does-not-belong-to-this-site.-you-may-affect-other-sites-if-you-edit-this-structure");
