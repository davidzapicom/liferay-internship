...
DDMTemplate ddmTemplate = journalEditArticleDisplayContext.getDDMTemplate();
      ...
      _jspx_th_aui_input_0.setName("ddmTemplateKey");
      _jspx_th_aui_input_0.setType("hidden");
      _jspx_th_aui_input_0.setValue( (ddmTemplate != null) ? ddmTemplate.getTemplateKey() : StringPool.BLANK );
      ...
      out.write('	');
if (
 ListUtil.isNotEmpty(ddmStructure.getTemplates()) ) {
      out.write("\n");
      ...
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("ddmTemplateName\" readonly=\"readonly\" title=\"");
      out.print( LanguageUtil.get(request, "template-name") );
      out.write("\" type=\"text\" value=\"");
      out.print( (ddmTemplate != null) ? HtmlUtil.escape(ddmTemplate.getName(locale)) : LanguageUtil.get(request, "no-template") );
      out.write("\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t");
if (
 (article != null) && !article.isNew() && (journalEditArticleDisplayContext.getClassNameId() == JournalArticleConstants.CLASS_NAME_ID_DEFAULT) ) {
      ...
      _jspx_th_clay_button_0.setId( liferayPortletResponse.getNamespace() + "previewWithTemplate" );
      ...
      out.write("\t\t\t");
if (
 (ddmTemplate != null) && DDMTemplatePermission.contains(permissionChecker, ddmTemplate, ActionKeys.UPDATE) ) {
      out.write("\n");
      out.write("\t\t\t\t");
...
if (
 ddmTemplate != null ) {
      ...
      _jspx_th_liferay$1frontend_component_0.setComponentId( liferayPortletResponse.getNamespace() + "selectStructureField" );
      _jspx_th_liferay$1frontend_component_0.setContext( journalEditArticleDisplayContext.getTemplateComponentContext() );
      _jspx_th_liferay$1frontend_component_0.setModule("js/article/Template");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("this-template-will-be-used-when-showing-the-content-within-a-widget");
  ...
  private boolean _jspx_meth_aui_button_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setId("selectDDMTemplate");
  ...
  private boolean _jspx_meth_aui_button_1(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_1.setId("editDDMTemplate");
    _jspx_th_aui_button_1.setValue("edit");
  ...
  private boolean _jspx_meth_aui_button_2(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_2.setId("clearDDMTemplate");
    _jspx_th_aui_button_2.setValue("clear");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("there-are-no-templates");
