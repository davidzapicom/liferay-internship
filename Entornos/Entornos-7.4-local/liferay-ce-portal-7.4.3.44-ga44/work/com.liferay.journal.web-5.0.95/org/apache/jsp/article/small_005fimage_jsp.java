...
String smallImageSource = journalEditArticleDisplayContext.getSmallImageSource();
      ...
      _jspx_th_liferay$1ui_error$1marker_0.setValue("featured-image");
...
JournalFileUploadsConfiguration journalFileUploadsConfiguration = (JournalFileUploadsConfiguration)request.getAttribute(JournalFileUploadsConfiguration.class.getName());
      ...
      if (_jspx_eval_liferay$1ui_error_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ui_error_0, _jspx_page_context))
            return;
          out.write(' ');
          out.print( HtmlUtil.escape(StringUtil.merge(journalFileUploadsConfiguration.imageExtensions(), ", ")) );
          out.write('.');
          out.write('\n');
      ...
      if (_jspx_eval_liferay$1ui_error_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_liferay$1ui_message_1.setArguments( LanguageUtil.formatStorageSize(journalFileUploadsConfiguration.smallImageMaxSize(), locale) );
      ...
      _jspx_th_aui_select_0.setIgnoreRequestValue( journalEditArticleDisplayContext.isChangeStructure() );
      ...
      out.write("\t");
if (
 (article != null) && Validator.isNotNull(article.getArticleImageURL(themeDisplay)) ) {
      out.write("\n");
      ...
      _jspx_th_aui_input_0.setIgnoreRequestValue( journalEditArticleDisplayContext.isChangeStructure() );
