...
public final class edit_005fbasic_005finfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
DDMStructure ddmStructure = journalEditDDMTemplateDisplayContext.getDDMStructure();
      ...
      out.print( LanguageUtil.format(locale, "select-x", "structure") );
      out.write("\" id=\"");
      out.print( liferayPortletResponse.getNamespace() );
      out.write("ddmStructure\" name=\"structure\" readonly value=\"");
      out.print( (ddmStructure != null) ? ddmStructure.getName(locale) : StringPool.BLANK );
      out.write("\" class=\"form-control lfr-input-resource\" />\n");
      out.write("\t\t</div>\n");
      out.write("\n");
      out.write("\t\t");
if (
 (ddmTemplate == null) || (ddmTemplate.getClassPK() == 0) ) {
      out.write("\n");
      ...
      _jspx_th_clay_button_0.setIcon("plus");
      _jspx_th_clay_button_0.setId( liferayPortletResponse.getNamespace() + "selectDDMStructure" );
      ...
      out.write("\n");
if (
 !journalEditDDMTemplateDisplayContext.autogenerateDDMTemplateKey() && (ddmTemplate == null) ) {
      out.write('\n');
      out.write('	');
      ...
      _jspx_th_aui_input_1.setDefaultLanguageId( (ddmTemplate == null) ? LocaleUtil.toLanguageId(LocaleUtil.getSiteDefault()): ddmTemplate.getDefaultLanguageId() );
...
if (
 ddmTemplate != null ) {
      ...
      _jspx_th_aui_input_2.setHelpMessage("template-key-help");
      _jspx_th_aui_input_2.setName("ddmTemplateKey");
      _jspx_th_aui_input_2.setType("resource");
      _jspx_th_aui_input_2.setValue( ddmTemplate.getTemplateKey() );
      ...
      _jspx_th_aui_input_3.setName("url");
      _jspx_th_aui_input_3.setType("resource");
      _jspx_th_aui_input_3.setValue( getDDMTemplateURL );
	...
	Portlet portlet = PortletLocalServiceUtil.getPortletById(portletDisplay.getId());
      ...
      _jspx_th_aui_input_4.setName("webDavURL");
      _jspx_th_aui_input_4.setType("resource");
      _jspx_th_aui_input_4.setValue( ddmTemplate.getWebDavURL(themeDisplay, WebDAVUtil.getStorageToken(portlet)) );
      ...
      _jspx_th_aui_input_5.setHelpMessage("journal-template-cacheable-help");
      _jspx_th_aui_input_5.setLabelCssClass("control-label");
      _jspx_th_aui_input_5.setName("cacheable");
      _jspx_th_aui_input_5.setValue( journalEditDDMTemplateDisplayContext.isCacheable() );
...
if (
 (ddmTemplate == null) || (ddmTemplate.getClassPK() == 0) ) {
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\tconst selectDDMStructure = document.getElementById(\n");
          out.write("\t\t\t'");
          ...
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tconst ddmStructure = document.getElementById(\n");
          out.write("\t\t\t'");
          ...
          if (_jspx_meth_portlet_namespace_6((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_1, _jspx_page_context))
            return;
          out.write("classPK\n");
          out.write("\t\t\t\t\t\t\t.value != itemValue.ddmstructureid\n");
          out.write("\t\t\t\t\t) {\n");
          out.write("\t\t\t\t\t\tdocument.");
          ...
          if (_jspx_meth_portlet_namespace_8((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_1, _jspx_page_context))
            return;
          out.write("classPK.value =\n");
          out.write("\t\t\t\t\t\t\titemValue.ddmstructureid;\n");
          out.write("\n");
          ...
          out.write("',\n");
          out.write("\t\t\t\turl: '");
          out.print( journalDisplayContext.getSelectDDMStructureURL() );
          out.write(">',\n");
          out.write("\t\t\t});\n");
          out.write("\t\t};\n");
          out.write("\n");
          out.write("\t\tif (selectDDMStructure) {\n");
          out.write("\t\t\tselectDDMStructure.addEventListener('click', onClick);\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tif (ddmStructure) {\n");
          out.write("\t\t\tddmStructure.addEventListener('click', onClick);\n");
          out.write("\t\t}\n");
          out.write("\t");
  ...
  private boolean _jspx_meth_liferay$1ui_icon$1help_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_icon$1help_0.setMessage("structure-help");
  ...
  private boolean _jspx_meth_aui_input_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_input_0.setHelpMessage("template-key-help");
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("-cacheableWarningMessage'\n");
        out.write("\t);\n");
