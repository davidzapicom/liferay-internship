...
MasterLayoutManagementToolbarDisplayContext masterLayoutManagementToolbarDisplayContext = new MasterLayoutManagementToolbarDisplayContext(request, liferayPortletRequest, liferayPortletResponse, masterLayoutDisplayContext);
      ...
      _jspx_th_clay_management$1toolbar_0.setManagementToolbarDisplayContext( masterLayoutManagementToolbarDisplayContext );
      _jspx_th_clay_management$1toolbar_0.setPropsTransformer("js/propsTransformers/MasterLayoutManagementToolbarPropsTransformer");
      ...
      _jspx_th_portlet_actionURL_0.setName("/layout_page_template_admin/delete_master_layout");
      _jspx_th_portlet_actionURL_0.setVar("deleteMasterLayoutURL");
      ...
      _jspx_th_aui_form_0.setAction( deleteMasterLayoutURL );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_error_0.setKey( PortalException.class.getName() );
        _jspx_th_liferay$1ui_error_0.setMessage("one-or-more-entries-could-not-be-deleted");
        ...
        _jspx_th_liferay$1ui_error_1.setKey( RequiredLayoutPageTemplateEntryException.class.getName() );
        _jspx_th_liferay$1ui_error_1.setMessage("you-cannot-delete-master-pages-that-are-used-by-a-page,-a-page-template,-or-a-display-page-template");
        ...
        _jspx_th_liferay$1ui_search$1container_0.setId( masterLayoutManagementToolbarDisplayContext.getSearchContainerId() );
        _jspx_th_liferay$1ui_search$1container_0.setSearchContainer( masterLayoutDisplayContext.getMasterLayoutsSearchContainer() );
			...
			row.setData(
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_clay_vertical$1card_0.setPropsTransformer("js/propsTransformers/MasterLayoutDropdownPropsTransformer");
                  _jspx_th_clay_vertical$1card_0.setVerticalCard( new MasterLayoutVerticalCard(layoutPageTemplateEntry, renderRequest, renderResponse, searchContainer.getRowChecker()) );
      ...
      _jspx_th_portlet_actionURL_1.setName("/layout_page_template_admin/update_layout_page_template_entry_preview");
      _jspx_th_portlet_actionURL_1.setVar("masterLayoutPreviewURL");
      ...
      _jspx_th_aui_form_1.setAction( masterLayoutPreviewURL );
      _jspx_th_aui_form_1.setName("masterLayoutPreviewFm");
  ...
  private boolean _jspx_meth_liferay$1ui_success_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_success_0.setKey("masterPagePublished");
    _jspx_th_liferay$1ui_success_0.setMessage("the-master-page-was-published-successfully");
