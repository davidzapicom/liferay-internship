...
public final class view_005fitem_005fselector_005fview_005fdescriptor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/META-INF/resources/WEB-INF/liferay-item-selector.tld");
...
SearchContainer<Object> searchContainer = itemSelectorViewDescriptorRendererDisplayContext.getSearchContainer();
      ...
      out.write('\n');
if (
 itemSelectorViewDescriptor.isShowManagementToolbar() ) {
      out.write('\n');
      out.write('	');
      ...
      _jspx_th_clay_management$1toolbar_0.setManagementToolbarDisplayContext( new ItemSelectorViewDescriptorRendererManagementToolbarDisplayContext(itemSelectorViewDescriptorRendererDisplayContext, request, liferayPortletRequest, liferayPortletResponse, searchContainer) );
      ...
      if (_jspx_eval_clay_container$1fluid_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write('	');
if (
 itemSelectorViewDescriptor.isShowBreadcrumb() ) {
        out.write("\n");
        out.write("\t\t");
        ...
        _jspx_th_liferay$1site$1navigation_breadcrumb_0.setBreadcrumbEntries( itemSelectorViewDescriptorRendererDisplayContext.getBreadcrumbEntries(currentURLObj) );
        ...
        if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_search$1container$1row_0.setKeyProperty( itemSelectorViewDescriptor.getKeyProperty() );
          ...
          if (_jspx_eval_liferay$1ui_search$1container$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            entry = (Object) _jspx_page_context.findAttribute("entry");
			...
			row.setData(
              ...
              out.write("\t\t\t\t");
if (
 itemSelectorViewDescriptorRendererDisplayContext.isIconDisplayStyle() ) {
              out.write("\n");
              out.write("\t\t\t\t\t");
              out.write("\n");
              out.write("\t\t\t\t\t\t");
if (
 itemDescriptor.isCompact() ) {
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t");
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_clay_horizontal$1card_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_search$1container$1column$1text_0);
                  _jspx_th_clay_horizontal$1card_0.setHorizontalCard( new ItemDescriptorHorizontalCard(itemDescriptor, renderRequest, searchContainer.getRowChecker()) );
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_clay_vertical$1card_0.setVerticalCard( new ItemDescriptorVerticalCard(itemDescriptor, renderRequest, searchContainer.getRowChecker()) );
 ...
 itemSelectorViewDescriptorRendererDisplayContext.isDescriptiveDisplayStyle() ) {
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t");
              ...
              out.write("\t\t\t\t\t");
if (
 itemDescriptor.getUserId() != UserConstants.USER_ID_DEFAULT ) {
              out.write("\n");
              out.write("\t\t\t\t\t\t");
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1user_0.setUserId( itemDescriptor.getUserId() );
              ...
              out.write("\t\t\t\t\t");
if (
 Validator.isNotNull(itemDescriptor.getImageURL()) ) {
              out.write("\n");
              out.write("\t\t\t\t\t\t");
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1image_0.setSrc( itemDescriptor.getImageURL() );
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1text_2.setCssClass("entry");
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("\t\t\t\t\t\t");
if (
 Objects.nonNull(itemDescriptor.getModifiedDate()) ) {
                  out.write("\n");
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t");
                  ...
                  out.write("\t\t\t\t\t\t\t\t");
if (
 Validator.isNotNull(itemDescriptor.getUserName()) ) {
                  out.write("\n");
                  ...
                  _jspx_th_liferay$1ui_message_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_search$1container$1column$1text_2);
                  _jspx_th_liferay$1ui_message_0.setArguments( new String[] {itemDescriptor.getUserName(), modifiedDateDescription} );
                  ...
                  _jspx_th_liferay$1ui_message_1.setArguments( modifiedDateDescription );
                  ...
                  out.write("\t\t\t\t\t\t\t");
                  out.print( itemDescriptor.getTitle(locale) );
                  out.write("\n");
                  out.write("\t\t\t\t\t\t</p>\n");
                  out.write("\n");
                  out.write("\t\t\t\t\t\t<p class=\"h6 text-default\">\n");
                  out.write("\t\t\t\t\t\t\t");
                  out.print( itemDescriptor.getSubtitle(locale) );
                  out.write("\n");
                  out.write("\t\t\t\t\t\t</p>\n");
                  out.write("\n");
                  out.write("\t\t\t\t\t\t");
if (
 itemDescriptor.getStatus() != null ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t<span class=\"text-default\">\n");
                  out.write("\t\t\t\t\t\t\t\t");
                  //  aui:workflow-status
                  ...
                  _jspx_th_aui_workflow$1status_0.setStatus( itemDescriptor.getStatus() );
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1text_4.setName("user");
              _jspx_th_liferay$1ui_search$1container$1column$1text_4.setValue( itemDescriptor.getUserName() );
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1text_5.setName("modified-date");
...
if (
 Objects.nonNull(itemDescriptor.getModifiedDate()) ) {
                  ...
                  _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_search$1container$1column$1text_5);
...
if (
 itemDescriptor.getStatus() != null ) {
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1status_0.setCssClass("text-nowrap");
              _jspx_th_liferay$1ui_search$1container$1column$1status_0.setName("status");
              _jspx_th_liferay$1ui_search$1container$1column$1status_0.setStatus( itemDescriptor.getStatus() );
          ...
          _jspx_th_liferay$1ui_search$1iterator_0.setDisplayStyle( itemSelectorViewDescriptorRendererDisplayContext.getDisplayStyle() );
      ...
      out.write('	');
if (
 itemSelectorViewDescriptorRendererDisplayContext.isMultipleSelection() ) {
      out.write("\n");
      out.write("\t\t");
      //  aui:script
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tsearchContainer.on('rowToggled', (event) => {\n");
          out.write("\t\t\t\tvar searchContainerItems = event.elements.allSelectedElements;\n");
          out.write("\n");
          out.write("\t\t\t\tvar arr = [];\n");
          out.write("\n");
          out.write("\t\t\t\tsearchContainerItems.each(function () {\n");
          out.write("\t\t\t\t\tvar domElement = this.ancestor('li');\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (domElement == null) {\n");
          out.write("\t\t\t\t\t\tdomElement = this.ancestor('tr');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (domElement == null) {\n");
          out.write("\t\t\t\t\t\tdomElement = this.ancestor('dd');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (domElement != null) {\n");
          out.write("\t\t\t\t\t\tvar itemValue = domElement.getDOM().dataset.value;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tarr.push(itemValue);\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t});\n");
          out.write("\n");
          out.write("\t\t\t\tLiferay.Util.getOpener().Liferay.fire(\n");
          out.write("\t\t\t\t\t'");
          out.print( itemSelectorViewDescriptorRendererDisplayContext.getItemSelectedEventName() );
          out.write("',\n");
          out.write("\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\tdata: {\n");
          out.write("\t\t\t\t\t\t\treturnType:\n");
          out.write("\t\t\t\t\t\t\t\t'");
          out.print( itemSelectorViewDescriptorRendererDisplayContext.getReturnType() );
          out.write("',\n");
          out.write("\t\t\t\t\t\t\tvalue: arr,\n");
          out.write("\t\t\t\t\t\t},\n");
          out.write("\t\t\t\t\t}\n");
      ...
      _jspx_th_aui_script_1.setRequire("frontend-js-web/liferay/delegate/delegate.es as delegateModule");
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\t\t\tvar selectItemHandler = delegate(\n");
          ...
          out.write("\t\t\t\t'.entry',\n");
          out.write("\t\t\t\t(event) => {\n");
          out.write("\t\t\t\t\tvar activeCards = document.querySelectorAll('.form-check-card.active');\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (activeCards.length) {\n");
          out.write("\t\t\t\t\t\tactiveCards.forEach((card) => {\n");
          out.write("\t\t\t\t\t\t\tcard.classList.remove('active');\n");
          out.write("\t\t\t\t\t\t});\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tvar target = event.delegateTarget;\n");
          out.write("\n");
          out.write("\t\t\t\t\tvar newSelectedCard = target.closest('.form-check-card');\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (newSelectedCard) {\n");
          out.write("\t\t\t\t\t\tnewSelectedCard.classList.add('active');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tvar domElement = target.closest('li');\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (domElement == null) {\n");
          out.write("\t\t\t\t\t\tdomElement = target.closest('tr');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (domElement == null) {\n");
          out.write("\t\t\t\t\t\tdomElement = target.closest('dd');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tvar itemValue = '';\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (domElement != null) {\n");
          out.write("\t\t\t\t\t\titemValue = domElement.dataset.value;\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tLiferay.Util.getOpener().Liferay.fire(\n");
          out.write("\t\t\t\t\t\t'");
          ...
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tLiferay.on('destroyPortlet', function removeListener() {\n");
          out.write("\t\t\t\tselectItemHandler.dispose();\n");
          out.write("\n");
          out.write("\t\t\t\tLiferay.detach('destroyPortlet', removeListener);\n");
          out.write("\t\t\t});\n");
          out.write("\t\t");
