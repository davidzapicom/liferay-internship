...
renderResponse.setTitle(selGroup.getLayoutRootNodeName(privateLayout, locale));
      ...
      _jspx_th_portlet_actionURL_0.setName("/layout_admin/edit_layout_set");
      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1footer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\t\t");
if (
 GroupPermissionUtil.contains(permissionChecker, selGroup, ActionKeys.MANAGE_LAYOUTS) && SitesUtil.isLayoutSetPrototypeUpdateable(selLayoutSet) ) {
          out.write("\n");
          out.write("\t\t\t");
...
if (
 Validator.isNotNull(backURL) ) {
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("/layout_admin/edit_layout_set");
