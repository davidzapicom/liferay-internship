...
String virtualHostname = layoutsAdminDisplayContext.getVirtualHostname();
      ...
      out.write('	');
if (
 Validator.isNotNull(virtualHostname) ) {
      out.write("\n");
      out.write("\t\t");
      //  aui:input
      ...
      _jspx_th_aui_input_0.setHelpMessage("robots-txt-help");
      ...
      _jspx_th_aui_input_0.setValue( layoutsAdminDisplayContext.getRobots() );
