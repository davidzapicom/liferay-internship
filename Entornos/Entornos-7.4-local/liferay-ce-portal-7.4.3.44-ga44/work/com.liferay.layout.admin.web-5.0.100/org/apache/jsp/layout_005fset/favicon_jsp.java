...
public final class favicon_jsp extends org.apache.jasper.runtime.HttpJspBase
...
LayoutSet selLayoutSet = layoutsAdminDisplayContext.getSelLayoutSet();
      ...
      out.write("\t<img alt=\"");
      out.print( HtmlUtil.escape(layoutsAdminDisplayContext.getFaviconTitle()) );
      out.write("\" class=\"mb-2\" height=\"16\" id=\"");
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("faviconImage\" src=\"");
      out.print( layoutsAdminDisplayContext.getFaviconURL() );
      out.write("\" width=\"16\" />\n");
      out.write("\n");
      out.write("\t<p>\n");
      out.write("\t\t<b>");
      ...
      out.print( layoutsAdminDisplayContext.getFaviconTitle() );
      out.write("</span>\n");
      out.write("\t</p>\n");
      out.write("\n");
      out.write("\t");
      ...
      _jspx_th_aui_input_0.setName("faviconFileEntryId");
      _jspx_th_aui_input_0.setType("hidden");
      _jspx_th_aui_input_0.setValue( selLayoutSet.getFaviconFileEntryId() );
      ...
      _jspx_th_aui_input_1.setName("themeFaviconCETExternalReferenceCode");
      _jspx_th_aui_input_1.setType("hidden");
      _jspx_th_aui_input_1.setValue( layoutsAdminDisplayContext.getThemeFaviconCETExternalReferenceCode() );
      ...
      _jspx_th_aui_button_1.setDisabled( !layoutsAdminDisplayContext.isClearFaviconButtonEnabled() );
      _jspx_th_aui_button_1.setName("clearFaviconButton");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\tconst clearFaviconButton = document.getElementById(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("clearFaviconButton'\n");
          out.write("\t\t);\n");
          out.write("\t\tconst faviconFileEntryId = document.getElementById(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("faviconFileEntryId'\n");
          out.write("\t\t);\n");
          out.write("\t\tconst faviconImage = document.getElementById(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("faviconImage'\n");
          out.write("\t\t);\n");
          out.write("\t\tconst faviconTitle = document.getElementById(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("faviconTitle'\n");
          out.write("\t\t);\n");
          out.write("\t\tconst selectLayoutButton = document.getElementById(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_6((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("selectFaviconButton'\n");
          out.write("\t\t);\n");
          out.write("\t\tconst themeFaviconCETExternalReferenceCode = document.getElementById(\n");
          out.write("\t\t\t'");
          if (_jspx_meth_portlet_namespace_7((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("themeFaviconCETExternalReferenceCode'\n");
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tselectLayoutButton.addEventListener('click', (event) => {\n");
          ...
          out.write("\t\t\t\t\t\tselectedItem.value &&\n");
          out.write("\t\t\t\t\t\tthemeFaviconCETExternalReferenceCode\n");
          out.write("\t\t\t\t\t) {\n");
          out.write("\t\t\t\t\t\tconst itemValue = JSON.parse(selectedItem.value);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (\n");
          out.write("\t\t\t\t\t\t\tselectedItem.returnType ===\n");
          out.write("\t\t\t\t\t\t\t'");
          out.print( CETItemSelectorReturnType.class.getName() );
          out.write("'\n");
          out.write("\t\t\t\t\t\t) {\n");
          out.write("\t\t\t\t\t\t\tfaviconFileEntryId.value = 0;\n");
          out.write("\t\t\t\t\t\t\tthemeFaviconCETExternalReferenceCode.value =\n");
          out.write("\t\t\t\t\t\t\t\titemValue.cetExternalReferenceCode;\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\t\tfaviconFileEntryId.value = itemValue.fileEntryId;\n");
          out.write("\t\t\t\t\t\t\tthemeFaviconCETExternalReferenceCode.value = '';\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (itemValue.url) {\n");
          out.write("\t\t\t\t\t\t\tfaviconImage.src = itemValue.url;\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\t\tfaviconImage.classList.add('d-none');\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tfaviconTitle.innerHTML = itemValue.title || itemValue.name;\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t},\n");
          out.write("\t\t\t\tselectEventName:\n");
          out.write("\t\t\t\t\t'");
          out.print( layoutsAdminDisplayContext.getSelectFaviconEventName() );
          out.write("',\n");
          out.write("\t\t\t\ttitle: '");
          ...
          out.write("',\n");
          out.write("\t\t\t\turl: '");
          out.print( layoutsAdminDisplayContext.getFileEntryItemSelectorURL() );
          out.write("',\n");
          out.write("\t\t\t});\n");
          out.write("\t\t});\n");
          out.write("\n");
          ...
          out.write("\t\t\tthemeFaviconCETExternalReferenceCode\n");
          out.write("\t\t) {\n");
          out.write("\t\t\tclearFaviconButton.addEventListener('click', (event) => {\n");
          out.write("\t\t\t\tfaviconFileEntryId.value = 0;\n");
          out.write("\t\t\t\tfaviconImage.classList.add('d-none');\n");
          out.write("\t\t\t\tfaviconTitle.innerHTML =\n");
          out.write("\t\t\t\t\t'");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("favicon-name");
  ...
  private boolean _jspx_meth_aui_button_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setName("selectFaviconButton");
    _jspx_th_aui_button_0.setValue("change-favicon");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("change-favicon");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("favicon-from-theme");
