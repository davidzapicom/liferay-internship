...
public final class layout_005factions_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/control/menu/init.jsp");
...
LayoutActionsDisplayContext layoutActionsDisplayContext = (LayoutActionsDisplayContext)request.getAttribute(LayoutAdminWebKeys.LAYOUT_ACTIONS_DISPLAY_CONTEXT);
      ...
      _jspx_th_clay_dropdown$1menu_0.setDisplayType("unstyled");
      _jspx_th_clay_dropdown$1menu_0.setDropdownItems( layoutActionsDisplayContext.getDropdownItems() );
      _jspx_th_clay_dropdown$1menu_0.setIcon("ellipsis-v");
      _jspx_th_clay_dropdown$1menu_0.setMenuProps(
			HashMapBuilder.put(
				"className", "cadmin"
			).build()
		);
      _jspx_th_clay_dropdown$1menu_0.setMonospaced( true );
      _jspx_th_clay_dropdown$1menu_0.setPropsTransformer("js/LayoutActionDropdownPropsTransformer");
