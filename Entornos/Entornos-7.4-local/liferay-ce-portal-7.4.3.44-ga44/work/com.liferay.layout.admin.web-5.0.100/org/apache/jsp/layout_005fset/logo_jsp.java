...
LayoutSet selLayoutSet = layoutsAdminDisplayContext.getSelLayoutSet();
	...
	FileSizeException fileSizeException = (FileSizeException)errorException;
          ...
          _jspx_th_liferay$1ui_message_0.setArguments( LanguageUtil.formatStorageSize(fileSizeException.getMaxSize(), locale) );
...
if (
 group.isPrivateLayoutsEnabled() ) {
      ...
      out.write("\n");
if (
 liveGroup.isLayoutSetPrototype() && !PropsValues.LAYOUT_SET_PROTOTYPE_PROPAGATE_LOGO ) {
      out.write("\n");
...
if (selLayoutSet.getLogoId() == 0) {
	...
	if (selLayoutSet.getLogoId() == guestGroupLayoutSet.getLogoId()) {
      ...
      _jspx_th_liferay$1ui_logo$1selector_0.setDefaultLogo( defaultLogo );
      ...
      _jspx_th_liferay$1ui_logo$1selector_0.setShowButtons( GroupPermissionUtil.contains(permissionChecker, layoutsAdminDisplayContext.getSelGroup(), ActionKeys.MANAGE_LAYOUTS) && SitesUtil.isLayoutSetPrototypeUpdateable(selLayoutSet) );
...
boolean showSiteNameDefault = GetterUtil.getBoolean(selTheme.getSetting("show-site-name-default"), showSiteNameSupported);
      ...
      _jspx_th_aui_input_0.setValue( GetterUtil.getBoolean(selLayoutSet.getSettingsProperty("showSiteName"), showSiteNameDefault) );
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("upload-a-logo-for-pages-that-is-used-instead-of-the-default-enterprise-logo");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("modifying-the-site-template-logo-only-affects-sites-that-are-not-yet-created");
