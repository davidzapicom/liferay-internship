...
Group guestGroup = GroupLocalServiceUtil.getGroup(company.getCompanyId(), GroupConstants.GUEST);
      ...
      out.write('	');
if (
 !layoutsAdminDisplayContext.isPrivateLayout() && (layoutsAdminDisplayContext.getLiveGroupId() != guestGroup.getGroupId()) ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
...
if (
 group.isPrivateLayoutsEnabled() ) {
      ...
      _jspx_th_aui_input_0.setValue( PropertiesParamUtil.getBoolean(layoutsAdminDisplayContext.getGroupTypeSettingsUnicodeProperties(), request, "mergeGuestPublicPages") );
      ...
      _jspx_th_aui_input_1.setHelpMessage( LanguageUtil.format(request, "you-can-configure-the-top-level-pages-of-this-site-to-merge-with-the-top-level-pages-of-the-x-site", HtmlUtil.escape(guestGroup.getDescriptiveName(locale)), false) );
      _jspx_th_aui_input_1.setLabel( LanguageUtil.format(request, "merge-x-pages", HtmlUtil.escape(guestGroup.getDescriptiveName(locale)), false) );
      _jspx_th_aui_input_1.setName("mergeGuestPublicPages");
      _jspx_th_aui_input_1.setType("checkbox");
      _jspx_th_aui_input_1.setValue( PropertiesParamUtil.getBoolean(layoutsAdminDisplayContext.getGroupTypeSettingsUnicodeProperties(), request, "mergeGuestPublicPages") );
