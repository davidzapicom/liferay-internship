...
if (
 !group.isLayoutPrototype() ) {
      ...
      _jspx_th_aui_input_0.setValue( GetterUtil.getString(layoutTypeSettings.getProperty("query-string")) );
...
String targetType = GetterUtil.getString(layoutTypeSettings.getProperty("targetType"));
      ...
      _jspx_th_aui_select_0.setId("targetType");
      _jspx_th_aui_select_0.setLabel("target-type");
      _jspx_th_aui_select_0.setName("TypeSettingsProperties--targetType--");
      ...
      if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_aui_option_0.setLabel(new String("specific-frame"));
          _jspx_th_aui_option_0.setSelected( !Objects.equals(targetType, "useNewTab") );
          ...
          _jspx_th_aui_option_1.setLabel(new String("new-tab"));
          _jspx_th_aui_option_1.setSelected( Objects.equals(targetType, "useNewTab") );
          _jspx_th_aui_option_1.setValue(new String("useNewTab"));
      ...
      _jspx_th_aui_input_1.setId("target");
      ...
      _jspx_th_aui_input_1.setValue( GetterUtil.getString(layoutTypeSettings.getProperty("target")) );
      _jspx_th_aui_input_1.setWrapperCssClass( Objects.equals(targetType, "useNewTab") ? "hide" : "" );
      ...
      _jspx_th_liferay$1frontend_component_0.setModule("js/Advanced");
