...
JSONObject formBuilderContextJSONObject = ddmFormAdminDisplayContext.getFormBuilderContextJSONObject();
      ...
      _jspx_th_liferay$1ui_icon_0.setOnClick( "Liferay.fire('openExportFormModal', { exportFormURL:'" + ddmFormAdminDisplayContext.getExportFormURL(ParamUtil.getLong(request, liferayPortletResponse.getNamespace() + "formInstanceId")) + "'});" );
