...
FormInstancePermissionCheckerHelper formInstancePermissionCheckerHelper = ddmFormAdminDisplayContext.getPermissionCheckerHelper();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 formInstancePermissionCheckerHelper.isShowViewEntriesIcon(ddmFormAdminDisplayContext.getDDMFormInstance()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 !DDMFormInstanceExpirationStatusUtil.isFormExpired(formInstanceRecord.getFormInstance(), timeZone) && formInstancePermissionCheckerHelper.isShowEditIcon(ddmFormAdminDisplayContext.getDDMFormInstance()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          if (_jspx_eval_portlet_renderURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_6.setName("formInstanceRecordId");
            _jspx_th_portlet_param_6.setValue( String.valueOf(formInstanceRecord.getFormInstanceRecordId()) );
            ...
            _jspx_th_portlet_param_7.setValue( String.valueOf(formInstanceRecord.getFormInstanceId()) );
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowDeleteIcon(ddmFormAdminDisplayContext.getDDMFormInstance()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
          ...
          if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_9.setName("formInstanceRecordId");
            _jspx_th_portlet_param_9.setValue( String.valueOf(formInstanceRecord.getFormInstanceRecordId()) );
  ...
  private boolean _jspx_meth_portlet_param_4(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_4.setValue("/admin/edit_form_instance_record.jsp");
