...
import com.liferay.site.item.selector.web.internal.frontend.taglib.clay.servlet.taglib.SiteVerticalCard;
...
if (
 siteItemSelectorViewDisplayContext.isShowChildSitesLink() ) {
        ...
        _jspx_th_liferay$1site$1navigation_breadcrumb_0.setBreadcrumbEntries( BreadcrumbEntriesUtil.getBreadcrumbEntries(request, false, false, false, true, true) );
...
if (
 groupItemSelectorCriterion.isAllowNavigation() && group.isActive() ) {
                  ...
                  _jspx_th_liferay$1ui_message_1.setKey( group.getScopeLabel(themeDisplay) );
...
if (
 group.isActive() ) {
                      ...
                      _jspx_th_aui_a_3.setCssClass( hasURL ? "card-title selector-button text-truncate" : "disabled text-muted" );
                      _jspx_th_aui_a_3.setData( data );
                      _jspx_th_aui_a_3.setHref( hasURL ? "javascript:void(0);" : StringPool.BLANK );
                      ...
                      _jspx_th_liferay$1ui_message_3.setArguments( siteVerticalCard.getTitle() );
...
if (
 groupItemSelectorCriterion.isAllowNavigation() && group.isActive() ) {
                    ...
                    if (_jspx_eval_clay_content$1col_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      _jspx_th_aui_a_5.setCssClass("btn btn-monospaced btn-outline-borderless btn-outline-secondary btn-sm");
...
if (
 group.isActive() ) {
                  ...
                  _jspx_th_aui_a_6.setHref("javascript:void(0);");
                  ...
                  _jspx_th_liferay$1ui_message_4.setArguments( HtmlUtil.escape(siteItemSelectorViewDisplayContext.getGroupName(group)) );
                  _jspx_th_liferay$1ui_message_4.setKey("x-inactive");
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  if (_jspx_eval_aui_a_8 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    _jspx_th_liferay$1ui_message_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_a_8);
                    _jspx_th_liferay$1ui_message_5.setArguments( String.valueOf(childGroups.size()) );
                    _jspx_th_liferay$1ui_message_5.setKey("x-child-sites");
