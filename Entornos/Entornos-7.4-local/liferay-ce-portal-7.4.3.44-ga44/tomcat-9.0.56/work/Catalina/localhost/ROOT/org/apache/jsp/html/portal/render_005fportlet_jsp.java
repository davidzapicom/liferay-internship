 ...
 * Generated at: 2022-10-25 08:35:07 UTC
...
private static final Log _log = LogFactoryUtil.getLog("portal_web.docroot.html.portal.render_portlet_jsp");
  ...
  static {
    ...
    _jspx_dependants.put("/html/portal/render_portlet-ext.jsp", Long.valueOf(1664405435000L));
    ...
    _jspx_dependants.put("/html/portal/init.jsp", Long.valueOf(1664405435000L));
...
if (
 useDefaultTemplate || portletException || addNotAjaxablePortlet ) {
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(936,3) name = page type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (portletDisplay.isShowMoveIcon()) {
	...
	if (portlet.isStaticEnd()) {
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(967,0) name = position type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (
 (refreshPortletId = (String)SessionMessages.get(liferayRenderRequest, portletId + SessionMessages.KEY_SUFFIX_REFRESH_PORTLET)) != null ) {
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(1005,2) name = position type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_aui_005fscript_005f1.setPosition("inline");
        // /html/portal/render_portlet.jsp(1005,2) name = use type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (
 (closeRedirect = (String)SessionMessages.get(liferayRenderRequest, portletId + SessionMessages.KEY_SUFFIX_CLOSE_REDIRECT)) != null ) {
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(1035,2) name = use type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (
 (closeRefreshPortletId = (String)SessionMessages.get(liferayRenderRequest, portletId + SessionMessages.KEY_SUFFIX_CLOSE_REFRESH_PORTLET)) != null ) {
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(1083,2) name = use type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
